...
public class Block {
    ...
    public int getMetaFromState(IBlockState state) {
        if (null != state && !state.getPropertyNames().isEmpty()) {
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
        ...
        if (0 == i && block instanceof BlockSlab) {
            pos = pos.down();
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        return EnumFacing.DOWN == side && 0.0D < minY || (EnumFacing.UP == side && 1.0D > maxY || (EnumFacing.NORTH == side && 0.0D < minZ || (EnumFacing.SOUTH == side && 1.0D > maxZ || (EnumFacing.WEST == side && 0.0D < minX || (EnumFacing.EAST == side && 1.0D > maxX || !worldIn.getBlockState(pos).getBlock().isOpaqueCube())))));
    }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (null != axisalignedbb && mask.intersectsWith(axisalignedbb)) {
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos) {
        ...
        return 0.0F > f ? 0.0F : (!playerIn.canHarvestBlock(this) ? playerIn.getToolDigEfficiency(this) / f / 100.0F : playerIn.getToolDigEfficiency(this) / f / 30.0F);
    }
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        if (null != vec3 && (null == vec36 || start.squareDistanceTo(vec3) < start.squareDistanceTo(vec36))) {
            vec36 = vec3;
        }

        if (null != vec31 && (null == vec36 || start.squareDistanceTo(vec31) < start.squareDistanceTo(vec36))) {
            vec36 = vec31;
        }

        if (null != vec32 && (null == vec36 || start.squareDistanceTo(vec32) < start.squareDistanceTo(vec36))) {
            vec36 = vec32;
        }

        if (null != vec33 && (null == vec36 || start.squareDistanceTo(vec33) < start.squareDistanceTo(vec36))) {
            vec36 = vec33;
        }

        if (null != vec34 && (null == vec36 || start.squareDistanceTo(vec34) < start.squareDistanceTo(vec36))) {
            vec36 = vec34;
        }

        if (null != vec35 && (null == vec36 || start.squareDistanceTo(vec35) < start.squareDistanceTo(vec36))) {
            vec36 = vec35;
        }
    ...
    private boolean isVecInsideYZBounds(Vec3 point) {
        return null != point && point.yCoord >= this.minY && point.yCoord <= this.maxY && point.zCoord >= this.minZ && point.zCoord <= this.maxZ;
    }
    ...
    private boolean isVecInsideXZBounds(Vec3 point) {
        return null != point && point.xCoord >= this.minX && point.xCoord <= this.maxX && point.zCoord >= this.minZ && point.zCoord <= this.maxZ;
    }
    ...
    private boolean isVecInsideXYBounds(Vec3 point) {
        return null != point && point.xCoord >= this.minX && point.xCoord <= this.maxX && point.yCoord >= this.minY && point.yCoord <= this.maxY;
    }
    ...
    protected ItemStack createStackedBlock(IBlockState state) {
        ...
        if (null != item && item.getHasSubtypes()) {
    ...
    public static boolean isEqualTo(Block blockIn, Block other) {
        return null != blockIn && null != other && (blockIn == other || blockIn.isAssociatedBlock(other));
    }
    ...
    public static void registerBlocks() {
        ...
        for (Block block13 : blockRegistry) {
            if (block13.blockMaterial == Material.air) {
                ...
                boolean flag5 = 0 == block13.lightOpacity;
