...
public abstract class BlockBasePressurePlate extends Block {
    ...
    protected void setBlockBoundsBasedOnState0(IBlockState state) {
        boolean flag = 0 < getRedstoneStrength(state);
    ...
    protected void updateState(World worldIn, BlockPos pos, IBlockState state, int oldRedstoneStrength) {
        ...
        boolean flag = 0 < oldRedstoneStrength;
        boolean flag1 = 0 < i;
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (0 < getRedstoneStrength(state)) {
            this.updateNeighbors(worldIn, pos);
        }
    ...
    public int getStrongPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
        return EnumFacing.UP == side ? this.getRedstoneStrength(state) : 0;
    }
