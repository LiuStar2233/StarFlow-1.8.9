...
public class BlockBrewingStand extends BlockContainer {
    public static final PropertyBool[] HAS_BOTTLE = {PropertyBool.create("has_bottle_0"), PropertyBool.create("has_bottle_1"), PropertyBool.create("has_bottle_2")};
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        for (int i = 0; 3 > i; ++i) {
            iblockstate = iblockstate.withProperty(HAS_BOTTLE[i], Boolean.valueOf(0 < (meta & 1 << i)));
        }
