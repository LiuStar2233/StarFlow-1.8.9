...
public abstract class BlockButton extends Block {
    ...
    protected static boolean func_181088_a(World p_181088_0_, BlockPos p_181088_1_, EnumFacing p_181088_2_) {
        ...
        return EnumFacing.DOWN == p_181088_2_ ? World.doesBlockHaveSolidTopSurface(p_181088_0_, blockpos) : p_181088_0_.getBlockState(blockpos).getBlock().isNormalCube();
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        return this.getDefaultState().withProperty(FACING, enumfacing).withProperty(POWERED, Boolean.valueOf(0 < (meta & 8)));
    }
