...
public class BlockChest extends BlockContainer {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        } else if (EnumFacing.Axis.X != enumfacing.getAxis() || !flag && !flag1) {
            if (EnumFacing.Axis.Z == enumfacing.getAxis() && (flag2 || flag3)) {
                if (flag2) {
        ...
        if (worldIn.isRemote) {
            ...
            if (block != this && block1 != this) {
                ...
                if (block2 == this || block3 == this) {
                    ...
                    if (EnumFacing.NORTH == enumfacing2) {
                ...
                if (EnumFacing.WEST == enumfacing1) {
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                    ...
                    if (block == this) {
                        ...
                        if (tileentity1 instanceof TileEntityChest) {
                            if (EnumFacing.WEST != enumfacing && EnumFacing.NORTH != enumfacing) {
    ...
    public int getStrongPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
        return EnumFacing.UP == side ? this.getWeakPower(worldIn, pos, state, side) : 0;
    }
