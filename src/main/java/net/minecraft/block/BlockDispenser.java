...
public class BlockDispenser extends BlockContainer {
    ...
    private void setDefaultDirection(World worldIn, BlockPos pos, IBlockState state) {
        if (!worldIn.isRemote) {
            ...
            if (EnumFacing.NORTH == enumfacing && flag && !flag1) {
                enumfacing = EnumFacing.SOUTH;
            } else if (EnumFacing.SOUTH == enumfacing && flag1 && !flag) {
                ...
                if (EnumFacing.WEST == enumfacing && flag2 && !flag3) {
                    enumfacing = EnumFacing.EAST;
                } else if (EnumFacing.EAST == enumfacing && flag3 && !flag2) {
        ...
        if (null != tileentitydispenser) {
            ...
            if (0 > i) {
                ...
                if (ibehaviordispenseitem != IBehaviorDispenseItem.itemDispenseBehaviorProvider) {
                    ...
                    tileentitydispenser.setInventorySlotContents(i, 0 >= itemstack1.stackSize ? null : itemstack1);
                }
            }
        }
    }
    ...
    protected IBehaviorDispenseItem getBehavior(ItemStack stack) {
        return dispenseBehaviorRegistry.getObject(null == stack ? null : stack.getItem());
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(TRIGGERED, Boolean.valueOf(0 < (meta & 8)));
    }
