...
public class BlockDragonEgg extends Block {
    ...
    private void checkFall(World worldIn, BlockPos pos) {
        if (BlockFalling.canFallInto(worldIn, pos.down()) && 0 <= pos.getY()) {
            final int i = 32;
            ...
            if (!BlockFalling.fallInstantly && worldIn.isAreaLoaded(pos.add(-i, -i, -i), pos.add(i, i, i))) {
                ...
                for (blockpos = pos; BlockFalling.canFallInto(worldIn, blockpos) && 0 < blockpos.getY(); blockpos = blockpos.down()) {
                }
