...
public abstract class BlockFlower extends BlockBush {
    ...
    protected BlockFlower() {
        this.setDefaultState(this.blockState.getBaseState().withProperty(this.getTypeProperty(), EnumFlowerColor.RED == getBlockType() ? BlockFlower.EnumFlowerType.POPPY : BlockFlower.EnumFlowerType.DANDELION));
    }
    ...
    public enum EnumFlowerColor {
        ...
        public BlockFlower getBlock() {
            return YELLOW == this ? Blocks.yellow_flower : Blocks.red_flower;
        }
    }
    ...
    public enum EnumFlowerType implements IStringSerializable {
        ...
        public static BlockFlower.EnumFlowerType getType(BlockFlower.EnumFlowerColor blockType, int meta) {
            ...
            if (0 > meta || meta >= ablockflower$enumflowertype.length) {
                meta = 0;
            }
