...
public class BlockFlowerPot extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (null != itemstack && itemstack.getItem() instanceof ItemBlock) {
            TileEntityFlowerPot tileentityflowerpot = this.getTileEntity(worldIn, pos);

            if (null == tileentityflowerpot) {
                return false;
            } else if (null != tileentityflowerpot.getFlowerPotItem()) {
                return false;
            } else {
    ...
    public Item getItem(World worldIn, BlockPos pos) {
        TileEntityFlowerPot tileentityflowerpot = this.getTileEntity(worldIn, pos);
        return null != tileentityflowerpot && null != tileentityflowerpot.getFlowerPotItem() ? tileentityflowerpot.getFlowerPotItem() : Items.flower_pot;
    }
    ...
    public int getDamageValue(World worldIn, BlockPos pos) {
        TileEntityFlowerPot tileentityflowerpot = this.getTileEntity(worldIn, pos);
        return null != tileentityflowerpot && null != tileentityflowerpot.getFlowerPotItem() ? tileentityflowerpot.getFlowerPotData() : 0;
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (null != tileentityflowerpot && null != tileentityflowerpot.getFlowerPotItem()) {
