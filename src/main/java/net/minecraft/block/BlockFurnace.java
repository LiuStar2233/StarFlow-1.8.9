...
public class BlockFurnace extends BlockContainer {
    ...
    private void setDefaultFacing(World worldIn, BlockPos pos, IBlockState state) {
        if (!worldIn.isRemote) {
            ...
            if (EnumFacing.NORTH == enumfacing && block.isFullBlock() && !block1.isFullBlock()) {
                enumfacing = EnumFacing.SOUTH;
            } else if (EnumFacing.SOUTH == enumfacing && block1.isFullBlock() && !block.isFullBlock()) {
                enumfacing = EnumFacing.NORTH;
            } else if (EnumFacing.WEST == enumfacing && block2.isFullBlock() && !block3.isFullBlock()) {
                enumfacing = EnumFacing.EAST;
            } else if (EnumFacing.EAST == enumfacing && block3.isFullBlock() && !block2.isFullBlock()) {
