...
public class BlockPistonExtension extends Block {
    ...
    public Item getItem(World worldIn, BlockPos pos) {
        return EnumPistonType.STICKY == worldIn.getBlockState(pos).getValue(BlockPistonExtension.TYPE) ? Item.getItemFromBlock(Blocks.sticky_piston) : Item.getItemFromBlock(Blocks.piston);
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(TYPE, 0 < (meta & 8) ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (EnumPistonType.STICKY == state.getValue(BlockPistonExtension.TYPE)) {
            i |= 8;
        }
