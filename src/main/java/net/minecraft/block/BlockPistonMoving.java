...
public class BlockPistonMoving extends BlockContainer {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, BlockPistonExtension.getFacing(meta)).withProperty(TYPE, 0 < (meta & 8) ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (BlockPistonExtension.EnumPistonType.STICKY == state.getValue(BlockPistonMoving.TYPE)) {
            i |= 8;
        }
