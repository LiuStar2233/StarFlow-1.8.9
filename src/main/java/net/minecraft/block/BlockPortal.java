...
public class BlockPortal extends BlockBreakable {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (worldIn.provider.isSurfaceWorld() && worldIn.getGameRules().getBoolean("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId()) {
            ...
            for (blockpos = pos; !World.doesBlockHaveSolidTopSurface(worldIn, blockpos) && 0 < blockpos.getY(); blockpos = blockpos.down()) {
            }

            if (0 < i && !worldIn.getBlockState(blockpos.up()).getBlock().isNormalCube()) {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
        ...
        if (EnumFacing.Axis.X == enumfacing$axis) {
            f = 0.5F;
        }

        if (EnumFacing.Axis.Z == enumfacing$axis) {
            f1 = 0.5F;
        }
    ...
    public static int getMetaForAxis(EnumFacing.Axis axis) {
        return EnumFacing.Axis.X == axis ? 1 : (EnumFacing.Axis.Z == axis ? 2 : 0);
    }
    ...
    public boolean func_176548_d(World worldIn, BlockPos p_176548_2_) {
        ...
        if (blockportal$size.func_150860_b() && 0 == blockportal$size.field_150864_e) {
            ...
            if (blockportal$size1.func_150860_b() && 0 == blockportal$size1.field_150864_e) {
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        ...
        } else if (EnumFacing.Axis.Z == enumfacing$axis) {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (worldIn.getBlockState(pos).getBlock() == this) {
            ...
            if (EnumFacing.Axis.Z == enumfacing$axis && EnumFacing.EAST != side && EnumFacing.WEST != side) {
                return false;
            }

            if (EnumFacing.Axis.X == enumfacing$axis && EnumFacing.SOUTH != side && EnumFacing.NORTH != side) {
                return false;
            }
        }
        ...
        boolean flag4 = flag || flag1 || EnumFacing.Axis.X == enumfacing$axis;
        boolean flag5 = flag2 || flag3 || EnumFacing.Axis.Z == enumfacing$axis;
        return flag4 && EnumFacing.WEST == side || (flag4 && EnumFacing.EAST == side || (flag5 && EnumFacing.NORTH == side || flag5 && EnumFacing.SOUTH == side));
    }
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        if (null == entityIn.ridingEntity && null == entityIn.riddenByEntity) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(AXIS, 2 == (meta & 3) ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
    }
            ...
            for (EnumFacing.AxisDirection enumfacing$axisdirection : EnumFacing.AxisDirection.values()) {
                ...
                for (int i = 0; i < blockportal$size.func_181101_b(); ++i) {
                    for (int j = 0; j < blockportal$size.func_181100_a(); ++j) {
                        ...
                        if (null != blockworldstate.getBlockState() && blockworldstate.getBlockState().getBlock().getMaterial() != Material.air) {
    ...
    public static class Size {
        ...
        public Size(World worldIn, BlockPos p_i45694_2_, EnumFacing.Axis p_i45694_3_) {
            ...
            if (EnumFacing.Axis.X == p_i45694_3_) {
            ...
            for (BlockPos blockpos = p_i45694_2_; p_i45694_2_.getY() > blockpos.getY() - 21 && 0 < p_i45694_2_.getY() && this.func_150857_a(worldIn.getBlockState(p_i45694_2_.down()).getBlock()); p_i45694_2_ = p_i45694_2_.down()) {
            }
            ...
            if (0 <= i) {
                ...
                if (2 > field_150868_h || 21 < field_150868_h) {
                    this.field_150861_f = null;
                    this.field_150868_h = 0;
                }
            }

            if (null != field_150861_f) {
        ...
        protected int func_150858_a() {
            ...
            for (this.field_150862_g = 0; 21 > field_150862_g; ++this.field_150862_g) {
            ...
            if (21 >= field_150862_g && 3 <= field_150862_g) {
                return this.field_150862_g;
            } else {
                this.field_150861_f = null;
                this.field_150868_h = 0;
        ...
        public boolean func_150860_b() {
            return null != field_150861_f && 2 <= field_150868_h && 21 >= field_150868_h && 3 <= field_150862_g && 21 >= field_150862_g;
        }
