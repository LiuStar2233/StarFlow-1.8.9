...
public class BlockPumpkin extends BlockDirectional {
    ...
    private static final Predicate<IBlockState> field_181085_Q = new Predicate<IBlockState>() {
        public boolean apply(IBlockState p_apply_1_) {
            return null != p_apply_1_ && (p_apply_1_.getBlock() == Blocks.pumpkin || p_apply_1_.getBlock() == Blocks.lit_pumpkin);
        }
    };
    ...
    public boolean canDispenserPlace(World worldIn, BlockPos pos) {
        return null != getSnowmanBasePattern().match(worldIn, pos) || null != getGolemBasePattern().match(worldIn, pos);
    }

    private void trySpawnGolem(World worldIn, BlockPos pos) {
        BlockPattern.PatternHelper blockpattern$patternhelper;

        if (null != (blockpattern$patternhelper = getSnowmanPattern().match(worldIn, pos))) {
        ...
        } else if (null != (blockpattern$patternhelper = getGolemPattern().match(worldIn, pos))) {
