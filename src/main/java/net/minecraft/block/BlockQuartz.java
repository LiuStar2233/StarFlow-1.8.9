...
public class BlockQuartz extends Block {
    ...
    public int damageDropped(IBlockState state) {
        ...
        return EnumType.LINES_X != blockquartz$enumtype && EnumType.LINES_Z != blockquartz$enumtype ? blockquartz$enumtype.getMetadata() : BlockQuartz.EnumType.LINES_Y.getMetadata();
    }

    protected ItemStack createStackedBlock(IBlockState state) {
        BlockQuartz.EnumType blockquartz$enumtype = state.getValue(VARIANT);
        return EnumType.LINES_X != blockquartz$enumtype && EnumType.LINES_Z != blockquartz$enumtype ? super.createStackedBlock(state) : new ItemStack(Item.getItemFromBlock(this), 1, BlockQuartz.EnumType.LINES_Y.getMetadata());
    }
