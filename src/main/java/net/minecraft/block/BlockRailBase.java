...
public abstract class BlockRailBase extends Block {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
        ...
        if (null != blockrailbase$enumraildirection && blockrailbase$enumraildirection.isAscending()) {
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        if (!worldIn.isRemote) {
            ...
            if (EnumRailDirection.ASCENDING_EAST == blockrailbase$enumraildirection && !World.doesBlockHaveSolidTopSurface(worldIn, pos.east())) {
                flag = true;
            } else if (EnumRailDirection.ASCENDING_WEST == blockrailbase$enumraildirection && !World.doesBlockHaveSolidTopSurface(worldIn, pos.west())) {
                flag = true;
            } else if (EnumRailDirection.ASCENDING_NORTH == blockrailbase$enumraildirection && !World.doesBlockHaveSolidTopSurface(worldIn, pos.north())) {
                flag = true;
            } else if (EnumRailDirection.ASCENDING_SOUTH == blockrailbase$enumraildirection && !World.doesBlockHaveSolidTopSurface(worldIn, pos.south())) {
                flag = true;
            }
    ...
    public enum EnumRailDirection implements IStringSerializable {
        ...
        public boolean isAscending() {
            return ASCENDING_NORTH == this || ASCENDING_EAST == this || ASCENDING_SOUTH == this || ASCENDING_WEST == this;
        }
    ...
    public class Rail {
        ...
        private void func_150651_b() {
            for (int i = 0; i < this.field_150657_g.size(); ++i) {
                ...
                if (null != blockrailbase$rail && blockrailbase$rail.func_150653_a(this)) {
        ...
        private boolean func_150649_b(BlockRailBase.Rail rail) {
            return this.func_150653_a(rail) || 2 != field_150657_g.size();
        }
        ...
        private void func_150645_c(BlockRailBase.Rail p_150645_1_) {
            ...
            if (EnumRailDirection.NORTH_SOUTH == blockrailbase$enumraildirection) {
            ...
            if (EnumRailDirection.EAST_WEST == blockrailbase$enumraildirection) {
            ...
            if (null == blockrailbase$enumraildirection) {
                blockrailbase$enumraildirection = BlockRailBase.EnumRailDirection.NORTH_SOUTH;
            }
