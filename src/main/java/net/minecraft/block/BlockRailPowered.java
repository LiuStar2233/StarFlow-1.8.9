...
public class BlockRailPowered extends BlockRailBase {
    public static final PropertyEnum<BlockRailBase.EnumRailDirection> SHAPE = PropertyEnum.create("shape", BlockRailBase.EnumRailDirection.class, new Predicate<BlockRailBase.EnumRailDirection>() {
        public boolean apply(BlockRailBase.EnumRailDirection p_apply_1_) {
            return BlockRailBase.EnumRailDirection.NORTH_EAST != p_apply_1_ && BlockRailBase.EnumRailDirection.NORTH_WEST != p_apply_1_ && BlockRailBase.EnumRailDirection.SOUTH_EAST != p_apply_1_ && BlockRailBase.EnumRailDirection.SOUTH_WEST != p_apply_1_;
        }
    });
    ...
    protected boolean func_176567_a(World worldIn, BlockPos p_176567_2_, boolean p_176567_3_, int distance, BlockRailBase.EnumRailDirection p_176567_5_) {
        ...
        if (iblockstate.getBlock() != this) {
            ...
            return (BlockRailBase.EnumRailDirection.EAST_WEST != p_176567_5_ || BlockRailBase.EnumRailDirection.NORTH_SOUTH != blockrailbase$enumraildirection && BlockRailBase.EnumRailDirection.ASCENDING_NORTH != blockrailbase$enumraildirection && BlockRailBase.EnumRailDirection.ASCENDING_SOUTH != blockrailbase$enumraildirection) && ((BlockRailBase.EnumRailDirection.NORTH_SOUTH != p_176567_5_ || BlockRailBase.EnumRailDirection.EAST_WEST != blockrailbase$enumraildirection && BlockRailBase.EnumRailDirection.ASCENDING_EAST != blockrailbase$enumraildirection && BlockRailBase.EnumRailDirection.ASCENDING_WEST != blockrailbase$enumraildirection) && (iblockstate.getValue(POWERED).booleanValue() && (worldIn.isBlockPowered(p_176567_2_) || this.func_176566_a(worldIn, p_176567_2_, iblockstate, p_176567_3_, distance + 1))));
        }
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(SHAPE, BlockRailBase.EnumRailDirection.byMetadata(meta & 7)).withProperty(POWERED, Boolean.valueOf(0 < (meta & 8)));
    }
