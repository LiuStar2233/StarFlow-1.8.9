...
public class BlockSapling extends BlockBush implements IGrowable {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.isRemote) {
            ...
            if (9 <= worldIn.getLightFromNeighbors(pos.up()) && 0 == rand.nextInt(7)) {
    ...
    public void grow(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (0 == state.getValue(BlockSapling.STAGE).intValue()) {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        WorldGenerator worldgenerator = 0 == rand.nextInt(10) ? new WorldGenBigTree(true) : new WorldGenTrees(true);
        int i = 0;
        int j = 0;
        boolean flag = false;
    ...
    public boolean canUseBonemeal(World worldIn, Random rand, BlockPos pos, IBlockState state) {
        return 0.45D > (double) worldIn.rand.nextFloat();
    }
