...
public class BlockStairs extends Block {
    ...
    public void setBaseCollisionBounds(IBlockAccess worldIn, BlockPos pos) {
        if (EnumHalf.TOP == worldIn.getBlockState(pos).getValue(BlockStairs.HALF)) {
    ...
    public int func_176307_f(IBlockAccess blockAccess, BlockPos pos) {
        ...
        boolean flag = EnumHalf.TOP == blockstairs$enumhalf;

        if (EnumFacing.EAST == enumfacing) {
            ...
            if (isBlockStairs(block) && blockstairs$enumhalf == iblockstate1.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing1 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    return flag ? 1 : 2;
                }

                if (EnumFacing.SOUTH == enumfacing1 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    return flag ? 2 : 1;
                }
            }
            ...
            if (isBlockStairs(block1) && blockstairs$enumhalf == iblockstate2.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing2 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    return flag ? 2 : 1;
                }

                if (EnumFacing.SOUTH == enumfacing2 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    return flag ? 1 : 2;
                }
            }
        } else if (EnumFacing.SOUTH == enumfacing) {
            ...
            if (isBlockStairs(block2) && blockstairs$enumhalf == iblockstate3.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing3 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    return flag ? 2 : 1;
                }

                if (EnumFacing.EAST == enumfacing3 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    return flag ? 1 : 2;
                }
            }
        } else if (EnumFacing.NORTH == enumfacing) {
            ...
            if (isBlockStairs(block3) && blockstairs$enumhalf == iblockstate4.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing4 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    return flag ? 1 : 2;
                }

                if (EnumFacing.EAST == enumfacing4 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    return flag ? 2 : 1;
                }
            }
        }
    ...
    public int func_176305_g(IBlockAccess blockAccess, BlockPos pos) {
        ...
        if (EnumFacing.EAST == enumfacing) {
            ...
            if (isBlockStairs(block) && blockstairs$enumhalf == iblockstate1.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing1 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    return flag ? 1 : 2;
                }

                if (EnumFacing.SOUTH == enumfacing1 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    return flag ? 2 : 1;
                }
            }
        } else if (EnumFacing.WEST == enumfacing) {
            ...
            if (isBlockStairs(block1) && blockstairs$enumhalf == iblockstate2.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing2 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    return flag ? 2 : 1;
                }

                if (EnumFacing.SOUTH == enumfacing2 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    return flag ? 1 : 2;
                }
            }
        } else if (EnumFacing.SOUTH == enumfacing) {
            ...
            if (isBlockStairs(block2) && blockstairs$enumhalf == iblockstate3.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing3 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    return flag ? 2 : 1;
                }

                if (EnumFacing.EAST == enumfacing3 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    return flag ? 1 : 2;
                }
            }
        } else if (EnumFacing.NORTH == enumfacing) {
            ...
            if (isBlockStairs(block3) && blockstairs$enumhalf == iblockstate4.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing4 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    return flag ? 1 : 2;
                }

                if (EnumFacing.EAST == enumfacing4 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    return flag ? 2 : 1;
                }
            }
        }
        ...
        if (EnumFacing.EAST == enumfacing) {
            ...
            if (isBlockStairs(block) && blockstairs$enumhalf == iblockstate1.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing1 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    f5 = 0.5F;
                    flag1 = false;
                } else if (EnumFacing.SOUTH == enumfacing1 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    f4 = 0.5F;
                    flag1 = false;
                }
            }
            ...
            if (isBlockStairs(block1) && blockstairs$enumhalf == iblockstate2.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing2 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    f5 = 0.5F;
                    flag1 = false;
                } else if (EnumFacing.SOUTH == enumfacing2 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    f4 = 0.5F;
                    flag1 = false;
                }
            }
            ...
            if (isBlockStairs(block2) && blockstairs$enumhalf == iblockstate3.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing3 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    f3 = 0.5F;
                    flag1 = false;
                } else if (EnumFacing.EAST == enumfacing3 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    f2 = 0.5F;
                    flag1 = false;
                }
            }
            ...
            if (isBlockStairs(block3) && blockstairs$enumhalf == iblockstate4.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing4 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    f3 = 0.5F;
                    flag1 = false;
                } else if (EnumFacing.EAST == enumfacing4 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    f2 = 0.5F;
                    flag1 = false;
                }
            }
        ...
        if (EnumFacing.EAST == enumfacing) {
            ...
            if (isBlockStairs(block) && blockstairs$enumhalf == iblockstate1.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing1 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    ...
                    f5 = 0.5F;
                    flag1 = true;
                } else if (EnumFacing.SOUTH == enumfacing1 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    f4 = 0.5F;
                    f5 = 1.0F;
                    flag1 = true;
                }
            ...
            if (isBlockStairs(block1) && blockstairs$enumhalf == iblockstate2.getValue(HALF)) {
                ...
                if (EnumFacing.NORTH == enumfacing2 && !isSameStair(blockAccess, pos.north(), iblockstate)) {
                    ...
                    f5 = 0.5F;
                    flag1 = true;
                } else if (EnumFacing.SOUTH == enumfacing2 && !isSameStair(blockAccess, pos.south(), iblockstate)) {
                    f4 = 0.5F;
                    f5 = 1.0F;
                    flag1 = true;
                }
            ...
            if (isBlockStairs(block2) && blockstairs$enumhalf == iblockstate3.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing3 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    flag1 = true;
                } else if (EnumFacing.EAST == enumfacing3 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    f2 = 0.5F;
                    f3 = 1.0F;
                    flag1 = true;
                }
            ...
            if (isBlockStairs(block3) && blockstairs$enumhalf == iblockstate4.getValue(HALF)) {
                ...
                if (EnumFacing.WEST == enumfacing4 && !isSameStair(blockAccess, pos.west(), iblockstate)) {
                    flag1 = true;
                } else if (EnumFacing.EAST == enumfacing4 && !isSameStair(blockAccess, pos.east(), iblockstate)) {
                    f2 = 0.5F;
                    f3 = 1.0F;
                    flag1 = true;
                }
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        return EnumFacing.DOWN != facing && (EnumFacing.UP == facing || 0.5D >= (double) hitY) ? iblockstate.withProperty(HALF, BlockStairs.EnumHalf.BOTTOM) : iblockstate.withProperty(HALF, BlockStairs.EnumHalf.TOP);
    }
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        boolean flag = EnumHalf.TOP == iblockstate.getValue(BlockStairs.HALF);
        ...
        for (int j = 0; 8 > j; ++j) {
            ...
            if (0 > Arrays.binarySearch(aint, j)) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        IBlockState iblockstate = this.getDefaultState().withProperty(HALF, 0 < (meta & 4) ? BlockStairs.EnumHalf.TOP : BlockStairs.EnumHalf.BOTTOM);
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (EnumHalf.TOP == state.getValue(BlockStairs.HALF)) {
            i |= 4;
        }
