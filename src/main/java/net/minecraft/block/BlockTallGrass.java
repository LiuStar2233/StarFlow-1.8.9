...
public class BlockTallGrass extends BlockBush implements IGrowable {
    ...
    public int getRenderColor(IBlockState state) {
        if (state.getBlock() != this) {
            ...
            return EnumType.DEAD_BUSH == blocktallgrass$enumtype ? 16777215 : ColorizerGrass.getGrassColor(0.5D, 1.0D);
        }
    }
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return 0 == rand.nextInt(8) ? Items.wheat_seeds : null;
    }
    ...
    public boolean canGrow(World worldIn, BlockPos pos, IBlockState state, boolean isClient) {
        return EnumType.DEAD_BUSH != state.getValue(BlockTallGrass.TYPE);
    }
    ...
    public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state) {
        ...
        if (EnumType.FERN == state.getValue(BlockTallGrass.TYPE)) {
