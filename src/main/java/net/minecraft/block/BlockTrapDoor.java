...
public class BlockTrapDoor extends Block {
    ...
    public void setBounds(IBlockState state) {
        if (state.getBlock() == this) {
            boolean flag = DoorHalf.TOP == state.getValue(BlockTrapDoor.HALF);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        if (facing.getAxis().isHorizontal()) {
            ...
            iblockstate = iblockstate.withProperty(HALF, 0.5F < hitY ? BlockTrapDoor.DoorHalf.TOP : BlockTrapDoor.DoorHalf.BOTTOM);
        }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(OPEN, Boolean.valueOf(0 != (meta & 4))).withProperty(HALF, 0 == (meta & 8) ? BlockTrapDoor.DoorHalf.BOTTOM : BlockTrapDoor.DoorHalf.TOP);
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (DoorHalf.TOP == state.getValue(BlockTrapDoor.HALF)) {
            i |= 8;
        }
