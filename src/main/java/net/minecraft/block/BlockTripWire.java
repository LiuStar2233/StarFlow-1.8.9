...
public class BlockTripWire extends Block {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(POWERED, Boolean.valueOf(0 < (meta & 1))).withProperty(SUSPENDED, Boolean.valueOf(0 < (meta & 2))).withProperty(ATTACHED, Boolean.valueOf(0 < (meta & 4))).withProperty(DISARMED, Boolean.valueOf(0 < (meta & 8)));
    }
