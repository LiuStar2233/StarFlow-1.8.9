...
public class BlockTripWireHook extends Block {
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_) {
        ...
        if (flag != flag3) {
            for (int k = 1; k < i; ++k) {
                ...
                if (null != iblockstate2 && worldIn.getBlockState(blockpos2).getBlock() != Blocks.air) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta & 3)).withProperty(POWERED, Boolean.valueOf(0 < (meta & 8))).withProperty(ATTACHED, Boolean.valueOf(0 < (meta & 4)));
    }
