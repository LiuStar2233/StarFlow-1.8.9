...
public abstract class BlockWoodSlab extends BlockSlab {
    ...
    public String getUnlocalizedName(int meta) {
        return this.getUnlocalizedName() + "." + BlockPlanks.EnumType.byMetadata(meta).getUnlocalizedName();
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (!this.isDouble() && EnumBlockHalf.TOP == state.getValue(BlockSlab.HALF)) {
            i |= 8;
        }
