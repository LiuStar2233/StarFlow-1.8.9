...
public class EntityOtherPlayerMP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        if (!this.isItemInUse && this.isEating() && null != inventory.mainInventory[inventory.currentItem]) {
    ...
    public void onLivingUpdate() {
        if (0 < otherPlayerMPPosRotationIncrements) {
            ...
            for (d3 = this.otherPlayerMPYaw - (double) this.rotationYaw; -180.0D > d3; d3 += 360.0D) {
            }
