...
public class GuiCreateWorld extends GuiScreen {
    ...
    public static String getUncollidingSaveDirName(ISaveFormat saveLoader, String name) {
        ...
        while (null != saveLoader.getWorldInfo(name)) {
            name = name + "-";
        }
    ...
    private boolean canSelectCurWorldType() {
        ...
        return null != worldtype && worldtype.getCanBeCreated() && (worldtype != WorldType.DEBUG_WORLD || isShiftKeyDown());
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (28 == keyCode || 156 == keyCode) {
            this.actionPerformed((GuiButton) this.buttonList.get(0));
        }

        this.buttonList.get(0).enabled = 0 < worldNameField.getText().length();
        this.calcSaveDirName();
    }
