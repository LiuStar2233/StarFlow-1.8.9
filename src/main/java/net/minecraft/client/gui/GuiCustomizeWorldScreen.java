...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private final Predicate<String> field_175332_D = new Predicate<String>() {
        public boolean apply(String p_apply_1_) {
            ...
            return 0 == p_apply_1_.length() || null != f && Floats.isFinite(f.floatValue()) && 0.0F <= f.floatValue();
        }
    };
    ...
    public void func_175324_a(String p_175324_1_) {
        if (null != p_175324_1_ && 0 != p_175324_1_.length()) {
        ...
        switch (p_175330_1_) {
            ...
            case 162:
                if (0.0F > p_175330_2_) {
                    ...
                    return null != biomegenbase1 ? biomegenbase1.biomeName : "?";
                } else {
                    BiomeGenBase biomegenbase = BiomeGenBase.getBiomeGenArray()[(int) p_175330_2_];
                    return null != biomegenbase ? biomegenbase.biomeName : "?";
                }
        }
    }
    ...
    private void func_175328_i() {
        this.field_175345_v.enabled = 0 != field_175349_r.func_178059_e();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (0 == field_175339_B && !this.field_175340_C) {
