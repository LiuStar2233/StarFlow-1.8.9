...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (0 == mc.gameSettings.thirdPersonView && null != itemstack && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
        ...
        if (0 < mc.thePlayer.getSleepTimer()) {
        ...
        ScoreObjective scoreobjective1 = null != scoreobjective ? scoreobjective : scoreboard.getObjectiveInDisplaySlot(1);

        if (null != scoreobjective1) {
        ...
        if (!this.mc.gameSettings.keyBindPlayerList.isKeyDown() || this.mc.isIntegratedServerRunning() && 1 >= mc.thePlayer.sendQueue.getPlayerInfoMap().size() && null == scoreobjective1) {
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        if (0 < mc.thePlayer.experienceLevel) {
            this.mc.mcProfiler.startSection("expLevel");
            final int k1 = 8453920;
    ...
    public void renderSelectedItem(ScaledResolution scaledRes) {
        ...
        if (0 < remainingHighlightTicks && null != highlightingItemStack) {
    ...
    public void renderDemo(ScaledResolution scaledRes) {
        ...
        if (120500L <= mc.theWorld.getTotalWorldTime()) {
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        List<Score> list = Lists.newArrayList(Iterables.filter(collection, new Predicate<Score>() {
            public boolean apply(Score p_apply_1_) {
                return null != p_apply_1_.getPlayerName() && !p_apply_1_.getPlayerName().startsWith("#");
            }
        }));
    ...
    private void renderPlayerStats(ScaledResolution scaledRes) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            boolean flag = this.healthUpdateCounter > (long) this.updateCounter && 1L == (healthUpdateCounter - (long) updateCounter) / 3L % 2L;

            if (i < this.playerHealth && 0 < entityplayer.hurtResistantTime) {
                this.lastSystemTime = Minecraft.getSystemTime();
                this.healthUpdateCounter = this.updateCounter + 20;
            } else if (i > this.playerHealth && 0 < entityplayer.hurtResistantTime) {
                this.lastSystemTime = Minecraft.getSystemTime();
                this.healthUpdateCounter = this.updateCounter + 10;
            }

            if (1000L < Minecraft.getSystemTime() - lastSystemTime) {
                this.playerHealth = i;
            ...
            for (int i6 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; 0 <= i6; --i6) {
                int j6 = 16;
            ...
            if (null == entity) {
                ...
                for (int k6 = 0; 10 > k6; ++k6) {
                    ...
                    if (0.0F >= entityplayer.getFoodStats().getSaturationLevel() && 0 == updateCounter % (k * 3 + 1)) {
    ...
    private void renderBossHealth() {
        if (null != BossStatus.bossName && 0 < BossStatus.statusBarTime) {
    ...
    public void updateTick() {
        ...
        if (null != mc.thePlayer) {
            ...
            } else if (null != highlightingItemStack && itemstack.getItem() == this.highlightingItemStack.getItem() && ItemStack.areItemStackTagsEqual(itemstack, this.highlightingItemStack) && (itemstack.isItemStackDamageable() || itemstack.getMetadata() == this.highlightingItemStack.getMetadata())) {
                if (0 < remainingHighlightTicks) {
    ...
    public void displayTitle(String title, String subTitle, int timeFadeIn, int displayTime, int timeFadeOut) {
        if (null == title && null == subTitle && 0 > timeFadeIn && 0 > displayTime && 0 > timeFadeOut) {
            this.displayedTitle = "";
            this.displayedSubTitle = "";
            this.titlesTimer = 0;
        } else if (null != title) {
