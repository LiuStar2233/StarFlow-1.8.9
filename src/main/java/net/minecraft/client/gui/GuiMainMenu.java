...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public GuiMainMenu() {
        ...
        try {
            ...
            if (!list.isEmpty()) {
                ...
                } while (125780783 == splashText.hashCode());
            }
    ...
    public void initGui() {
        ...
        if (12 == calendar.get(2) + 1 && 24 == calendar.get(5)) {
            this.splashText = "Merry X-mas!";
        } else if (1 == calendar.get(2) + 1 && 1 == calendar.get(5)) {
            this.splashText = "Happy new year!";
        } else if (10 == calendar.get(2) + 1 && 31 == calendar.get(5)) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (1.0E-4D > (double) updateCounter) {
        ...
        if (null != openGLWarning1 && 0 < openGLWarning1.length()) {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        synchronized (this.threadLock) {
            if (0 < openGLWarning1.length() && mouseX >= this.field_92022_t && mouseX <= this.field_92020_v && mouseY >= this.field_92021_u && mouseY <= this.field_92019_w) {
