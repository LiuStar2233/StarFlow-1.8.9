...
public class GuiMerchant extends GuiContainer {
    ...
    public void updateScreen() {
        ...
        if (null != merchantrecipelist) {
            ...
            this.previousButton.enabled = 0 < selectedMerchantRecipe;
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button == this.nextButton) {
            ...
            if (null != merchantrecipelist && this.selectedMerchantRecipe >= merchantrecipelist.size()) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (null != merchantrecipelist && !merchantrecipelist.isEmpty()) {
            ...
            if (0 > k || k >= merchantrecipelist.size()) {
                return;
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (null != merchantrecipelist && !merchantrecipelist.isEmpty()) {
            ...
            if (this.isPointInRegion(36, 24, 16, 16, mouseX, mouseY) && null != itemstack) {
                this.renderToolTip(itemstack, mouseX, mouseY);
            } else if (null != itemstack1 && this.isPointInRegion(62, 24, 16, 16, mouseX, mouseY) && null != itemstack1) {
                this.renderToolTip(itemstack1, mouseX, mouseY);
            } else if (null != itemstack2 && this.isPointInRegion(120, 24, 16, 16, mouseX, mouseY) && null != itemstack2) {
