...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            GuiListExtended.IGuiListEntry guilistextended$iguilistentry = 0 > serverListSelector.func_148193_k() ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());

            if (2 == button.id && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
            ...
            } else if (7 == button.id && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        GuiListExtended.IGuiListEntry guilistextended$iguilistentry = 0 > i ? null : this.serverListSelector.getListEntry(i);
        ...
        if (63 == keyCode) {
            ...
            if (0 <= i) {
                if (200 == keyCode) {
                    if (isShiftKeyDown()) {
                        if (0 < i && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                        ...
                        if (this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k()) instanceof ServerListEntryLanScan) {
                            if (0 < serverListSelector.func_148193_k()) {
                ...
                } else if (28 != keyCode && 156 != keyCode) {
    ...
    public void selectServer(int index) {
        ...
        GuiListExtended.IGuiListEntry guilistextended$iguilistentry = 0 > index ? null : this.serverListSelector.getListEntry(index);
        this.btnSelectServer.enabled = false;
        this.btnEditServer.enabled = false;
        this.btnDeleteServer.enabled = false;

        if (null != guilistextended$iguilistentry && !(guilistextended$iguilistentry instanceof ServerListEntryLanScan)) {
