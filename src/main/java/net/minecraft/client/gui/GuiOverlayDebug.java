...
public class GuiOverlayDebug extends Gui {
    ...
    protected List<String> call() {
        ...
        if (this.isReducedDebug()) {
            return Lists.newArrayList("Minecraft 1.8.9 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", Integer.valueOf(blockpos.getX() & 15), Integer.valueOf(blockpos.getY() & 15), Integer.valueOf(blockpos.getZ() & 15)));
        } else {
            ...
            if (null != mc.theWorld && this.mc.theWorld.isBlockLoaded(blockpos)) {
                ...
                if (this.mc.isIntegratedServerRunning() && null != mc.getIntegratedServer()) {
            ...
            if (null != mc.entityRenderer && this.mc.entityRenderer.isShaderActive()) {
                list.add("Shader: " + this.mc.entityRenderer.getShaderGroup().getShaderGroupName());
            }

            if (null != mc.objectMouseOver && MovingObjectPosition.MovingObjectType.BLOCK == mc.objectMouseOver.typeOfHit && null != mc.objectMouseOver.getBlockPos()) {
    ...
    private void renderLagometer() {
        ...
        if (120 >= mc.gameSettings.limitFramerate) {
