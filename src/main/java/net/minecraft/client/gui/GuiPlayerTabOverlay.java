...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
        return null != networkPlayerInfoIn.getDisplayName() ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName());
    }
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list) {
            ...
            if (null != scoreObjectiveIn && IScoreObjectiveCriteria.EnumRenderType.HEARTS != scoreObjectiveIn.getRenderType()) {
        ...
        if (null != scoreObjectiveIn) {
            if (IScoreObjectiveCriteria.EnumRenderType.HEARTS == scoreObjectiveIn.getRenderType()) {
                l = 90;
            } else {
                l = j;
            }
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (flag) {
                    ...
                    boolean flag1 = null != entityplayer && entityplayer.isWearing(EnumPlayerModelParts.CAPE) && ("Dinnerbone".equals(gameprofile.getName()) || "Grumm".equals(gameprofile.getName()));
                    this.mc.getTextureManager().bindTexture(networkplayerinfo1.getLocationSkin());
                    int l2 = 8 + (flag1 ? 8 : 0);
                    int i3 = 8 * (flag1 ? -1 : 1);
                    Gui.drawScaledCustomSizeModalRect(j2, k2, 8.0F, (float) l2, 8, i3, 8, 8, 64.0F, 64.0F);

                    if (null != entityplayer && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                        int j3 = 8 + (flag1 ? 8 : 0);
                        int k3 = 8 * (flag1 ? -1 : 1);
                ...
                if (WorldSettings.GameType.SPECTATOR == networkplayerinfo1.getGameType()) {
                ...
                if (null != scoreObjectiveIn && WorldSettings.GameType.SPECTATOR != networkplayerinfo1.getGameType()) {
                    int k5 = j2 + i + 1;
                    int l5 = k5 + l;
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        if (0 > networkPlayerInfoIn.getResponseTime()) {
            j = 5;
        } else if (150 > networkPlayerInfoIn.getResponseTime()) {
            j = 0;
        } else if (300 > networkPlayerInfoIn.getResponseTime()) {
            j = 1;
        } else if (600 > networkPlayerInfoIn.getResponseTime()) {
            j = 2;
        } else if (1000 > networkPlayerInfoIn.getResponseTime()) {
            j = 3;
        } else {
            j = 4;
        }
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_) {
        ...
        if (IScoreObjectiveCriteria.EnumRenderType.HEARTS == p_175247_1_.getRenderType()) {
            this.mc.getTextureManager().bindTexture(icons);
            ...
            if (1000L < Minecraft.getSystemTime() - p_175247_6_.func_178847_n() || this.lastTimeOpened != p_175247_6_.func_178855_p()) {
            ...
            boolean flag = p_175247_6_.func_178858_o() > (long) this.guiIngame.getUpdateCounter() && 1L == (p_175247_6_.func_178858_o() - (long) guiIngame.getUpdateCounter()) / 3L % 2L;
            ...
            if (0 < j) {
                ...
                if (3.0F < f) {
                    ...
                    for (int j1 = 0; j1 < j; ++j1) {
                        ...
                        if (j1 * 2 + 1 < i) {
                            this.drawTexturedModalRect((float) p_175247_4_ + (float) j1 * f, (float) p_175247_2_, 10 <= j1 ? 160 : 52, 0, 9, 9);
                        }

                        if (j1 * 2 + 1 == i) {
                            this.drawTexturedModalRect((float) p_175247_4_ + (float) j1 * f, (float) p_175247_2_, 10 <= j1 ? 169 : 61, 0, 9, 9);
                        }
                    }
                } else {
    ...
    static class PlayerComparator implements Comparator<NetworkPlayerInfo> {
        ...
        public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
            ...
            return ComparisonChain.start().compareTrueFirst(WorldSettings.GameType.SPECTATOR != p_compare_1_.getGameType(), WorldSettings.GameType.SPECTATOR != p_compare_2_.getGameType()).compare(null != scoreplayerteam ? scoreplayerteam.getRegisteredName() : "", null != scoreplayerteam1 ? scoreplayerteam1.getRegisteredName() : "").compare(p_compare_1_.getGameProfile().getName(), p_compare_2_.getGameProfile().getName()).result();
        }
    }
}