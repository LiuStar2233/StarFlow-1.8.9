...
public class GuiRepair extends GuiContainer implements ICrafting {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (0 < anvil.maximumCost) {
            int i = 8453920;
            boolean flag = true;
            String s = I18n.format("container.repair.cost", Integer.valueOf(this.anvil.maximumCost));

            if (40 <= anvil.maximumCost && !this.mc.thePlayer.capabilities.isCreativeMode) {
    ...
    private void renameItem() {
        ...
        if (null != slot && slot.getHasStack() && !slot.getStack().hasDisplayName() && s.equals(slot.getStack().getDisplayName())) {
            s = "";
        }
    ...
    public void sendSlotContents(Container containerToSend, int slotInd, ItemStack stack) {
        if (0 == slotInd) {
            this.nameField.setText(null == stack ? "" : stack.getDisplayName());
            this.nameField.setEnabled(null != stack);
