...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    protected void handleComponentHover(IChatComponent component, int x, int y) {
        if (null != component && null != component.getChatStyle().getChatHoverEvent()) {
            HoverEvent hoverevent = component.getChatStyle().getChatHoverEvent();

            if (HoverEvent.Action.SHOW_ITEM == hoverevent.getAction()) {
            ...
            } else if (HoverEvent.Action.SHOW_ENTITY == hoverevent.getAction()) {
            ...
            } else if (HoverEvent.Action.SHOW_TEXT == hoverevent.getAction()) {
                this.drawHoveringText(NEWLINE_SPLITTER.splitToList(hoverevent.getValue().getFormattedText()), x, y);
            } else if (HoverEvent.Action.SHOW_ACHIEVEMENT == hoverevent.getAction()) {
    ...
    protected boolean handleComponentClick(IChatComponent component) {
        if (null == component) {
            ...
            if (isShiftKeyDown()) {
                if (null != component.getChatStyle().getInsertion()) {
                    this.setText(component.getChatStyle().getInsertion(), false);
                }
            } else if (null != clickevent) {
                if (ClickEvent.Action.OPEN_URL == clickevent.getAction()) {
                ...
                } else if (ClickEvent.Action.OPEN_FILE == clickevent.getAction()) {
                    URI uri1 = (new File(clickevent.getValue())).toURI();
                    this.openWebLink(uri1);
                } else if (ClickEvent.Action.SUGGEST_COMMAND == clickevent.getAction()) {
                    this.setText(clickevent.getValue(), true);
                } else if (ClickEvent.Action.RUN_COMMAND == clickevent.getAction()) {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        if (null != selectedButton && 0 == state) {
    ...
    public void handleMouseInput() throws IOException {
        ...
        if (Mouse.getEventButtonState()) {
            if (this.mc.gameSettings.touchscreen && 0 < touchValue++) {
                return;
            }
        ...
        } else if (-1 != eventButton && 0L < lastMouseEvent) {
    ...
    public static boolean isKeyComboCtrlX(int keyID) {
        return 45 == keyID && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlV(int keyID) {
        return 47 == keyID && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlC(int keyID) {
        return 46 == keyID && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }

    public static boolean isKeyComboCtrlA(int keyID) {
        return 30 == keyID && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }
