...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.get(0).enabled = 0 < serverIPField.getText().length() && 0 < serverIPField.getText().split(":").length && 0 < serverNameField.getText().length();
    }
