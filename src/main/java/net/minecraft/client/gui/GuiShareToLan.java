...
public class GuiShareToLan extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (102 == button.id) {
        ...
        } else if (104 == button.id) {
            if ("spectator".equals(field_146599_h)) {
                this.field_146599_h = "creative";
            } else if ("creative".equals(field_146599_h)) {
                this.field_146599_h = "adventure";
            } else if ("adventure".equals(field_146599_h)) {
            ...
            this.func_146595_g();
        } else if (103 == button.id) {
            this.field_146600_i = !this.field_146600_i;
            this.func_146595_g();
        } else if (101 == button.id) {
