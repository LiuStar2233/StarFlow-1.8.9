...
public class GuiSlider extends GuiButton {
    ...
    private String getDisplayString() {
        return null == formatHelper ? I18n.format(this.name) + ": " + this.func_175220_c() : this.formatHelper.getText(this.id, I18n.format(this.name), this.func_175220_c());
    }
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            if (this.isMouseDown) {
                ...
                if (0.0F > sliderPosition) {
                    this.sliderPosition = 0.0F;
                }

                if (1.0F < sliderPosition) {
