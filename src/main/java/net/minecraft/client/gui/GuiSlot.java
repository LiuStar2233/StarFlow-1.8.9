...
public abstract class GuiSlot {
    ...
    public int getSlotIndexFromScreenCoords(int p_148124_1_, int p_148124_2_) {
        ...
        return p_148124_1_ < this.getScrollBarX() && p_148124_1_ >= i && p_148124_1_ <= j && 0 <= l && 0 <= k && l < this.getSize() ? l : -1;
    }
    ...
    public void handleMouseInput() {
        if (this.isMouseYWithinSlotBounds(this.mouseY)) {
            if (0 == Mouse.getEventButton() && Mouse.getEventButtonState() && this.mouseY >= this.top && this.mouseY <= this.bottom) {
                int i = (this.width - this.getListWidth()) / 2;
                int j = (this.width + this.getListWidth()) / 2;
                int k = this.mouseY - this.top - this.headerPadding + (int) this.amountScrolled - 4;
                int l = k / this.slotHeight;

                if (l < this.getSize() && this.mouseX >= i && this.mouseX <= j && 0 <= l && 0 <= k) {
                    this.elementClicked(l, false, this.mouseX, this.mouseY);
                    this.selectedElement = l;
                } else if (this.mouseX >= i && this.mouseX <= j && 0 > k) {
            ...
            if (Mouse.isButtonDown(0) && this.getEnabled()) {
                if (-1 == initialClickY) {
                    ...
                    if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
                        ...
                        if (i1 < this.getSize() && this.mouseX >= j2 && this.mouseX <= k2 && 0 <= i1 && 0 <= l2) {
                            boolean flag = i1 == this.selectedElement && 250L > Minecraft.getSystemTime() - lastClicked;
                            this.elementClicked(i1, flag, this.mouseX, this.mouseY);
                            this.selectedElement = i1;
                            this.lastClicked = Minecraft.getSystemTime();
                        } else if (this.mouseX >= j2 && this.mouseX <= k2 && 0 > l2) {
