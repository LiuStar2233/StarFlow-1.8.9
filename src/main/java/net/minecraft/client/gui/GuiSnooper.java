...
public class GuiSnooper extends GuiScreen {
    ...
    public void initGui() {
        ...
        boolean flag = null != mc.getIntegratedServer() && null != mc.getIntegratedServer().getPlayerUsageSnooper();

        for (final Map.Entry<String, String> entry : (new TreeMap<String, String>(mc.getPlayerUsageSnooper().getCurrentStats())).entrySet()) {
