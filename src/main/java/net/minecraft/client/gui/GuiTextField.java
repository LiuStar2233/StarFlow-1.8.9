...
public class GuiTextField extends Gui {
    ...
    public void writeText(String p_146191_1_) {
        ...
        if (0 < text.length() && j < this.text.length()) {
        ...
        for (int k = 0; k < j; ++k) {
            if (!flag) {
                ...
                if (-1 == i) {
                    ...
                    while (p_146197_3_ && i < l && 32 == text.charAt(i)) {
                        ++i;
                    }
                }
            } else {
                while (p_146197_3_ && 0 < i && 32 == text.charAt(i - 1)) {
                    --i;
                }

                while (0 < i && 32 != text.charAt(i - 1)) {
                    --i;
                }
            }
        }
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
        ...
        if (this.isFocused && flag && 0 == p_146192_3_) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            String s = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            boolean flag = 0 <= j && j <= s.length();
            boolean flag1 = this.isFocused && 0 == cursorCounter / 6 % 2 && flag;
            ...
            if (!flag) {
                k1 = 0 < j ? l + this.width : l;
            } else if (flag2) {
                k1 = j1 - 1;
                --j1;
            }

            if (0 < s.length() && flag && j < s.length()) {
