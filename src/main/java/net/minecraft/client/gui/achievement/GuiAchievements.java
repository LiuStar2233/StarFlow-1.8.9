...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.loadingAchievements) {
            ...
            if (Mouse.isButtonDown(0)) {
                ...
                if ((0 == field_146554_D || 1 == field_146554_D) && mouseX >= k && mouseX < k + 224 && mouseY >= l && mouseY < l + 155) {
                    if (0 == field_146554_D) {
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        ...
        for (int l3 = 0; 155.0F > (float) l3 * f - (float) j2; ++l3) {
            float f2 = 0.6F - (float) (l1 + l3) / 25.0F * 0.3F;
            GlStateManager.color(f2, f2, f2, 1.0F);

            for (int i4 = 0; 224.0F > (float) i4 * f1 - (float) i2; ++i4) {
        ...
        for (int j5 = 0; j5 < AchievementList.achievementList.size(); ++j5) {
            ...
            if (null != achievement1.parentAchievement) {
        ...
        for (int i6 = 0; i6 < AchievementList.achievementList.size(); ++i6) {
            ...
            if (-24 <= l6 && -24 <= j7 && (float) l6 <= 224.0F * this.field_146570_r && (float) j7 <= 155.0F * this.field_146570_r) {
