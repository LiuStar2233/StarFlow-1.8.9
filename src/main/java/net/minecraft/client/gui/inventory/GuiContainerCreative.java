...
public class GuiContainerCreative extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        boolean flag = 1 == clickType;
        clickType = -999 == slotId && 0 == clickType ? 4 : clickType;

        if (null == slotIn && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && 5 != clickType) {
            InventoryPlayer inventoryplayer1 = this.mc.thePlayer.inventory;

            if (null != inventoryplayer1.getItemStack()) {
                if (0 == clickedButton) {
                ...
                if (1 == clickedButton) {
                    ...
                    if (0 == inventoryplayer1.getItemStack().stackSize) {
                        inventoryplayer1.setItemStack(null);
                    }
                }
            }
            ...
            if (slotIn == this.field_147064_C) {
            ...
            } else if (4 == clickType && null != slotIn && slotIn.getHasStack()) {
                ItemStack itemstack = slotIn.decrStackSize(0 == clickedButton ? 1 : slotIn.getStack().getMaxStackSize());
                this.mc.thePlayer.dropPlayerItemWithRandomChoice(itemstack, true);
                this.mc.playerController.sendPacketDropItem(itemstack);
            } else if (4 == clickType && null != mc.thePlayer.inventory.getItemStack()) {
                ...
                this.mc.thePlayer.inventoryContainer.slotClick(null == slotIn ? slotId : ((GuiContainerCreative.CreativeSlot) slotIn).slot.slotNumber, clickedButton, clickType, this.mc.thePlayer);
                this.mc.thePlayer.inventoryContainer.detectAndSendChanges();
            }
        } else if (5 != clickType && slotIn.inventory == field_147060_v) {
            InventoryPlayer inventoryplayer = this.mc.thePlayer.inventory;
            ItemStack itemstack1 = inventoryplayer.getItemStack();
            ItemStack itemstack2 = slotIn.getStack();

            if (2 == clickType) {
                if (null != itemstack2 && 0 <= clickedButton && 9 > clickedButton) {
            ...
            if (3 == clickType) {
                if (null == inventoryplayer.getItemStack() && slotIn.getHasStack()) {
            ...
            if (4 == clickType) {
                if (null != itemstack2) {
                    ...
                    itemstack3.stackSize = 0 == clickedButton ? 1 : itemstack3.getMaxStackSize();
            ...
            if (null != itemstack1 && itemstack1.isItemEqual(itemstack2)) {
                if (0 == clickedButton) {
                    if (flag) {
                ...
                } else if (1 >= itemstack1.stackSize) {
                    inventoryplayer.setItemStack(null);
                } else {
                    --itemstack1.stackSize;
                }
            } else if (null != itemstack2 && null == itemstack1) {
            ...
            this.inventorySlots.slotClick(null == slotIn ? slotId : slotIn.slotNumber, clickedButton, clickType, this.mc.thePlayer);

            if (2 == Container.getDragEvent(clickedButton)) {
                for (int i = 0; 9 > i; ++i) {
    ...
    protected void updateActivePotionEffects() {
        ...
        if (null != searchField && this.guiLeft != i) {
    ...
    public void onGuiClosed() {
        ...
        if (null != mc.thePlayer && null != mc.thePlayer.inventory) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (null != field_147064_C && selectedTabIndex == CreativeTabs.tabInventory.getTabIndex() && this.isPointInRegion(this.field_147064_C.xDisplayPosition, this.field_147064_C.yDisplayPosition, 16, 16, mouseX, mouseY)) {
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            if (null == creativetabs && stack.getItem() == Items.enchanted_book) {
    ...
    static class ContainerCreative extends Container {
        ...
        public boolean canMergeSlot(ItemStack stack, Slot slotIn) {
            return 90 < slotIn.yDisplayPosition;
        }

        public boolean canDragIntoSlot(Slot p_94531_1_) {
            return p_94531_1_.inventory instanceof InventoryPlayer || 90 < p_94531_1_.yDisplayPosition && 162 >= p_94531_1_.xDisplayPosition;
        }
    }
