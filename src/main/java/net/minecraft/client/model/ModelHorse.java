...
public class ModelHorse extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        boolean flag3 = 1 == i || 2 == i;
        float f1 = entityhorse.getHorseSize();
        boolean flag4 = null != entityhorse.riddenByEntity;
    ...
    private float updateHorseRotation(float p_110683_1_, float p_110683_2_, float p_110683_3_) {
        ...
        for (f = p_110683_2_ - p_110683_1_; -180.0F > f; f += 360.0F) {
        }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        boolean flag = 0 != entityhorse.field_110278_bp;
        boolean flag1 = entityhorse.isHorseSaddled();
        boolean flag2 = null != entityhorse.riddenByEntity;
        ...
        final float f13 = ((float) Math.PI * 3F / 2F);
        final float f14 = -1.0471976F;
