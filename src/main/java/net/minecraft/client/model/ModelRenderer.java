    ...
    public void render(float p_78785_1_) {
        if (!this.isHidden) {
            if (this.showModel) {
                ...
                if (0.0F == rotateAngleX && 0.0F == rotateAngleY && 0.0F == rotateAngleZ) {
                    if (0.0F == rotationPointX && 0.0F == rotationPointY && 0.0F == rotationPointZ) {
                    ...
                    if (0.0F != rotateAngleZ) {
                        GlStateManager.rotate(this.rotateAngleZ * (180F / (float) Math.PI), 0.0F, 0.0F, 1.0F);
                    }

                    if (0.0F != rotateAngleY) {
                        GlStateManager.rotate(this.rotateAngleY * (180F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
                    }

                    if (0.0F != rotateAngleX) {
