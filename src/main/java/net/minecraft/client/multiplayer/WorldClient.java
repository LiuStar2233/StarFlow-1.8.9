...
public class WorldClient extends World {
    ...
    public void tick() {
        ...
        for (int i = 0; 10 > i && !this.entitySpawnQueue.isEmpty(); ++i) {
    ...
    public void doVoidFogParticles(int posX, int posY, int posZ) {
        ...
        boolean flag = WorldSettings.GameType.CREATIVE == mc.playerController.getCurrentGameType() && null != itemstack && Block.getBlockFromItem(itemstack.getItem()) == Blocks.barrier;
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        crashreportcategory.addCrashSectionCallable("Server type", new Callable<String>() {
            public String call() throws Exception {
                return null == mc.getIntegratedServer() ? "Non-integrated multiplayer server" : "Integrated singleplayer server";
            }
        });
