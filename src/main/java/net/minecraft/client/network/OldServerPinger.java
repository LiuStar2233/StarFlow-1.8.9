        ...
        networkmanager.setNetHandler(new INetHandlerStatusClient() {
            ...
            public void handleServerInfo(S00PacketServerInfo packetIn) {
                if (this.field_183009_e) {
                    ...
                    if (null != serverstatusresponse.getServerDescription()) {
                        server.serverMOTD = serverstatusresponse.getServerDescription().getFormattedText();
                    } else {
                        server.serverMOTD = "";
                    }

                    if (null != serverstatusresponse.getProtocolVersionInfo()) {
                    ...
                    if (null != serverstatusresponse.getPlayerCountData()) {
                    ...
                    if (null != serverstatusresponse.getFavicon()) {
