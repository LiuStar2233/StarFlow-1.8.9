...
public class EntityFirework {
    ...
    public static class SparkFX extends EntityFX {
        ...
        public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
            if (!this.twinkle || this.particleAge < this.particleMaxAge / 3 || 0 == (particleAge + particleMaxAge) / 3 % 2) {
        ...
        public void onUpdate() {
            ...
            if (this.trail && this.particleAge < this.particleMaxAge / 2 && 0 == (particleAge + particleMaxAge) % 2) {
    ...
    public static class StarterFX extends EntityFX {
        ...
        public void onUpdate() {
            if (0 == fireworkAge && null != fireworkExplosions) {
                boolean flag = this.func_92037_i();
                boolean flag1 = false;

                if (3 <= fireworkExplosions.tagCount()) {
                    flag1 = true;
                } else {
                    for (int i = 0; i < this.fireworkExplosions.tagCount(); ++i) {
                        NBTTagCompound nbttagcompound = this.fireworkExplosions.getCompoundTagAt(i);

                        if (1 == nbttagcompound.getByte("Type")) {
                            flag1 = true;
                            break;
                        }
                    }
            ...
            if (0 == fireworkAge % 2 && null != fireworkExplosions && this.fireworkAge / 2 < this.fireworkExplosions.tagCount()) {
        ...
        private boolean func_92037_i() {
            ...
            return null == minecraft || null == minecraft.getRenderViewEntity() || 256.0D <= minecraft.getRenderViewEntity().getDistanceSq(posX, posY, posZ);
        }
        ...
        private void createParticle(double p_92034_1_, double p_92034_3_, double p_92034_5_, double p_92034_7_, double p_92034_9_, double p_92034_11_, int[] p_92034_13_, int[] p_92034_14_, boolean p_92034_15_, boolean p_92034_16_) {
            ...
            if (null != p_92034_14_ && 0 < p_92034_14_.length) {
