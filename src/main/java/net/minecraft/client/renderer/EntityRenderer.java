...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public boolean isShaderActive() {
        return OpenGlHelper.shadersSupported && null != theShaderGroup;
    }

    public void stopUseShader() {
        if (null != theShaderGroup) {
    ...
    public void updateRenderer() {
        if (OpenGlHelper.shadersSupported && null == ShaderLinkHelper.getStaticShaderLinkHelper()) {
        ...
        if (BossStatus.hasColorModifier) {
            ...
            if (1.0F < bossColorModifier) {
                this.bossColorModifier = 1.0F;
            }

            BossStatus.hasColorModifier = false;
        } else if (0.0F < bossColorModifier) {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (null != entity) {
            if (null != mc.theWorld) {
                ...
                for (int j = 0; j < list.size(); ++j) {
                    ...
                    if (axisalignedbb.isVecInside(vec3)) {
                        if (0.0D <= d2) {
                            ...
                            vec33 = null == movingobjectposition ? vec3 : movingobjectposition.hitVec;
                            d2 = 0.0D;
                        }
                    } else if (null != movingobjectposition) {
                ...
                if (null != pointedEntity && flag && 3.0D < vec3.distanceTo(vec33)) {
                    this.pointedEntity = null;
                ...
                if (null != pointedEntity && (d2 < d1 || null == mc.objectMouseOver)) {
    ...
    private void updateFovModifierHand() {
        ...
        if (1.5F < fovModifierHand) {
            this.fovModifierHand = 1.5F;
        }

        if (0.1F > fovModifierHand) {
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
        if (this.debugView) {
            ...
            if (entity instanceof EntityLivingBase && 0.0F >= ((EntityLivingBase) entity).getHealth()) {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            if (0.0F >= entitylivingbase.getHealth()) {
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
        ...
        } else if (0 < mc.gameSettings.thirdPersonView) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                if (2 == mc.gameSettings.thirdPersonView) {
                    f2 += 180.0F;
                }
    ...
    private void renderHand(float partialTicks, int xOffset) {
        if (!this.debugView) {
            ...
            if (0 == mc.gameSettings.thirdPersonView && !flag && !this.mc.gameSettings.hideGUI && !this.mc.playerController.isSpectator()) {
                this.enableLightmap();
            ...
            if (0 == mc.gameSettings.thirdPersonView && !flag) {
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (null != world) {
                ...
                for (int i = 0; 256 > i; ++i) {
                    ...
                    if (0 < world.getLastLightningBolt()) {
                    ...
                    if (1 == world.provider.getDimensionId()) {
                        f8 = 0.22F + f3 * 0.75F;
                        f9 = 0.28F + f6 * 0.75F;
                        f10 = 0.25F + f7 * 0.75F;
                    }
    ...
    private float getNightVisionBrightness(EntityLivingBase entitylivingbaseIn, float partialTicks) {
        ...
        return 200 < i ? 1.0F : 0.7F + MathHelper.sin(((float) i - partialTicks) * (float) Math.PI * 0.2F) * 0.3F;
    }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (!flag && this.mc.gameSettings.pauseOnLostFocus && (!this.mc.gameSettings.touchscreen || !Mouse.isButtonDown(1))) {
            if (500L < Minecraft.getSystemTime() - prevFrameTime) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (null != mc.theWorld) {
                ...
                if (OpenGlHelper.shadersSupported) {
                    ...
                    if (null != theShaderGroup && this.useShader) {
                        GlStateManager.matrixMode(5890);
                        GlStateManager.pushMatrix();
                        GlStateManager.loadIdentity();
                ...
                if (!this.mc.gameSettings.hideGUI || null != mc.currentScreen) {
        ...
        if (!this.drawBlockOutline) {
            ...
            if (flag && !((EntityPlayer) entity).capabilities.allowEdit) {
                ...
                if (null != mc.objectMouseOver && MovingObjectPosition.MovingObjectType.BLOCK == mc.objectMouseOver.typeOfHit) {
                    ...
                    if (WorldSettings.GameType.SPECTATOR == mc.playerController.getCurrentGameType()) {
                        flag = block.hasTileEntity() && this.mc.theWorld.getTileEntity(blockpos) instanceof IInventory;
                    } else {
                        flag = null != itemstack && (itemstack.canDestroy(block) || itemstack.canPlaceOn(block));
                    }
                }
            }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        ActiveRenderInfo.updateRenderInfo(this.mc.thePlayer, 2 == mc.gameSettings.thirdPersonView);
        ...
        if (4 <= mc.gameSettings.renderDistanceChunks) {
        ...
        if (128.0D > entity.posY + (double) entity.getEyeHeight()) {
        ...
        if (!this.debugView) {
            ...
            if (null != mc.objectMouseOver && entity.isInsideOfMaterial(Material.water) && flag) {
        ...
        if (flag && null != mc.objectMouseOver && !entity.isInsideOfMaterial(Material.water)) {
    ...
    private void renderCloudsCheck(RenderGlobal renderGlobalIn, float partialTicks, int pass) {
        if (0 != mc.gameSettings.shouldRenderClouds()) {
    ...
    private void addRainParticles() {
        ...
        if (0.0F != f) {
            ...
            if (1 == mc.gameSettings.particleSetting) {
                k >>= 1;
            } else if (2 == mc.gameSettings.particleSetting) {
                k = 0;
            }
            ...
            for (int l = 0; l < k; ++l) {
                ...
                if (blockpos1.getY() <= blockpos.getY() + i && blockpos1.getY() >= blockpos.getY() - i && biomegenbase.canRain() && 0.15F <= biomegenbase.getFloatTemperature(blockpos1)) {
            ...
            if (0 < j && this.random.nextInt(3) < this.rainSoundCounter++) {
                ...
                for (int l1 = i - i1; l1 <= i + i1; ++l1) {
                    ...
                    if (biomegenbase.canRain() || biomegenbase.getEnableSnow()) {
                        ...
                        if (k2 != l2) {
                            ...
                            if (0.15F <= world.getWorldChunkManager().getTemperatureAtHeight(f2, j2)) {
                                if (0 != j1) {
                                    if (0 <= j1) {
                                        tessellator.draw();
                                    }
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (4 <= mc.gameSettings.renderDistanceChunks) {
            ...
            Vec3 vec32 = 0.0F < MathHelper.sin(world.getCelestialAngleRadians(partialTicks)) ? new Vec3(d0, 0.0D, 0.0D) : new Vec3(1.0D, 0.0D, 0.0D);
