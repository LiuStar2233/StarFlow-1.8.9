...
public class ItemRenderer {
    ...
    private boolean isBlockTranslucent(Block blockIn) {
        return null != blockIn && EnumWorldBlockLayer.TRANSLUCENT == blockIn.getBlockLayer();
    }
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (null != itemToRender) {
            if (this.itemToRender.getItem() == Items.filled_map) {
                this.renderItemMap(abstractclientplayer, f2, f, f1);
            } else if (0 < abstractclientplayer.getItemInUseCount()) {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            if (-1 != iblockstate.getBlock().getRenderType()) {
    ...
    public void updateEquippedItem() {
        ...
        if (null != itemToRender && null != itemstack) {
            if (!this.itemToRender.getIsItemStackEqual(itemstack)) {
                flag = true;
            }
        } else flag = null != itemToRender || null != itemstack;
