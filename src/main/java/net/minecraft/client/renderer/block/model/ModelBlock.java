...
public class ModelBlock {
    ...
    public boolean isResolved() {
        return null == parentLocation || null != parent && this.parent.isResolved();
    }
    ...
    private ItemTransformVec3f getTransform(ItemCameraTransforms.TransformType type) {
        return null != parent && !this.cameraTransforms.func_181687_c(type) ? this.parent.getTransform(type) : this.cameraTransforms.getTransform(type);
    }
