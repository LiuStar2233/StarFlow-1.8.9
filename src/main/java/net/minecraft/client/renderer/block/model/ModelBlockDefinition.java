...
public class ModelBlockDefinition {
    ...
    public ModelBlockDefinition.Variants getVariants(String p_178330_1_) {
        ...
        if (null == modelblockdefinition$variants) {
    ...
    public static class Deserializer implements JsonDeserializer<ModelBlockDefinition> {
        ...
        protected ModelBlockDefinition.Variants parseVariants(final JsonDeserializationContext p_178335_1_, Map.Entry<String, JsonElement> p_178335_2_) {
    ...
    public static class Variant {
        ...
        public int hashCode() {
            ...
            i = 31 * i + (null != modelRotation ? this.modelRotation.hashCode() : 0);
