...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    protected float interpolateRotation(float par1, float par2, float par3) {
        ...
        for (f = par2 - par1; -180.0F > f; f += 360.0F) {
        }
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        boolean flag = 0 < (i >> 24 & 255);
        boolean flag1 = 0 < entitylivingbaseIn.hurtTime || 0 < entitylivingbaseIn.deathTime;
    ...
    protected boolean canRenderName(T entity) {
            ...
            if (null != team) {
                ...
                switch (team$enumvisible) {
                    ...
                    case HIDE_FOR_OTHER_TEAMS:
                        return null == team1 || team.isSameTeam(team1);
        ...
        return Minecraft.isGuiEnabled() && entity != this.renderManager.livingPlayer && !entity.isInvisibleToPlayer(entityplayersp) && null == entity.riddenByEntity;
    }
