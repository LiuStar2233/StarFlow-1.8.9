...
public class LayeredColorMaskTexture extends AbstractTexture {
    ...
    public void loadTexture(IResourceManager resourceManager) throws IOException {
        ...
        try {
            ...
            for (int j = 0; 17 > j && j < this.field_174949_h.size() && j < this.field_174950_i.size(); ++j) {
                ...
                if (null != s) {
                    ...
                    if (bufferedimage2.getWidth() == bufferedimage.getWidth() && bufferedimage2.getHeight() == bufferedimage.getHeight() && 6 == bufferedimage2.getType()) {
