...
public class TextureClock extends TextureAtlasSprite {
    ...
    public void updateAnimation() {
        if (!this.framesTextureData.isEmpty()) {
            ...
            for (d1 = d0 - this.currentAngle; -0.5D > d1; ++d1) {
            }
            ...
            for (i = (int) ((this.currentAngle + 1.0D) * (double) this.framesTextureData.size()) % this.framesTextureData.size(); 0 > i; i = (i + this.framesTextureData.size()) % this.framesTextureData.size()) {
            }
