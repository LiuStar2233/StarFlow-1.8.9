...
public class TextureCompass extends TextureAtlasSprite {
    ...
    public void updateAnimation() {
        ...
        if (null != minecraft.theWorld && null != minecraft.thePlayer) {
    ...
    public void updateCompass(World worldIn, double p_94241_2_, double p_94241_4_, double p_94241_6_, boolean p_94241_8_, boolean p_94241_9_) {
        if (!this.framesTextureData.isEmpty()) {
            ...
            if (p_94241_9_) {
                ...
                for (d3 = d0 - this.currentAngle; -Math.PI > d3; d3 += (Math.PI * 2D)) {
                }
            ...
            for (i = (int) ((this.currentAngle / (Math.PI * 2D) + 1.0D) * (double) this.framesTextureData.size()) % this.framesTextureData.size(); 0 > i; i = (i + this.framesTextureData.size()) % this.framesTextureData.size()) {
            }
