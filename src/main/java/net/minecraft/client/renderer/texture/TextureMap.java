...
public class TextureMap extends AbstractTexture implements ITickableTextureObject {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        for (Map.Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet()) {
            ...
            try {
                ...
                if (null != texturemetadatasection) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (0 < i2 && i2 < abufferedimage.length - 1 && null == abufferedimage[i2]) {
    ...
    private ResourceLocation completeResourceLocation(ResourceLocation location, int p_147634_2_) {
        return 0 == p_147634_2_ ? new ResourceLocation(location.getResourceDomain(), String.format("%s/%s%s", this.basePath, location.getResourcePath(), ".png")) : new ResourceLocation(location.getResourceDomain(), String.format("%s/mipmaps/%s.%d%s", this.basePath, location.getResourcePath(), Integer.valueOf(p_147634_2_), ".png"));
    }
