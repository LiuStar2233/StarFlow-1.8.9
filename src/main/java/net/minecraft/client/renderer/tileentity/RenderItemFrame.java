...
public class RenderItemFrame extends Render<EntityItemFrame> {
    ...
    public void doRender(EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (null != entity.getDisplayedItem() && entity.getDisplayedItem().getItem() == Items.filled_map) {
    ...
    private void renderItem(EntityItemFrame itemFrame) {
        ...
        if (null != itemstack) {
            ...
            if (item == Items.filled_map) {
                ...
                if (null != textureatlassprite && 0 < textureatlassprite.getFrameCount()) {
    ...
    protected void renderName(EntityItemFrame entity, double x, double y, double z) {
        if (Minecraft.isGuiEnabled() && null != entity.getDisplayedItem() && entity.getDisplayedItem().hasDisplayName() && this.renderManager.pointedEntity == entity) {
            final float f = 1.6F;
