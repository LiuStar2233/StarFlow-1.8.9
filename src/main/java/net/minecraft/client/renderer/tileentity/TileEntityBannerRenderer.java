...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer<TileEntityBanner> {
    ...
    private ResourceLocation func_178463_a(TileEntityBanner bannerObj) {
        ...
        if (s.isEmpty()) {
            ...
            if (null == tileentitybannerrenderer$timedbannertexture) {
                if (256 <= TileEntityBannerRenderer.DESIGNS.size()) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (60000L < i - tileentitybannerrenderer$timedbannertexture1.systemTime) {
