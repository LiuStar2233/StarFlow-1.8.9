...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
    ...
    protected boolean func_148314_g() {
        ...
        return 0 < i && list.get(i - 1).func_148310_d();
    }

    protected boolean func_148307_h() {
        List<ResourcePackListEntry> list = this.resourcePacksGUI.getListContaining(this);
        int i = list.indexOf(this);
        return 0 <= i && i < list.size() - 1 && list.get(i + 1).func_148310_d();
    }
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
        if (this.func_148310_d() && 32 >= p_148278_5_) {
            if (this.func_148309_e()) {
                ...
                if (1 != j) {
                    ...
                    String s = I18n.format("resourcePack.incompatible.confirm." + (1 < j ? "new" : "old"));
            ...
            if (16 > p_148278_5_ && this.func_148308_f()) {
                this.resourcePacksGUI.getListContaining(this).remove(this);
            ...
            if (16 < p_148278_5_ && 16 > p_148278_6_ && this.func_148314_g()) {
            ...
            if (16 < p_148278_5_ && 16 < p_148278_6_ && this.func_148307_h()) {
                List<ResourcePackListEntry> list = this.resourcePacksGUI.getListContaining(this);
                int i = list.indexOf(this);
                list.remove(this);
                list.add(i + 1, this);
