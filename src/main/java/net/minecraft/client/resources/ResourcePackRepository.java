...
public class ResourcePackRepository {
        ...
        while (iterator.hasNext()) {
            ...
            for (ResourcePackRepository.Entry resourcepackrepository$entry : this.repositoryEntriesAll) {
                if (resourcepackrepository$entry.getResourcePackName().equals(s)) {
                    if (1 == resourcepackrepository$entry.func_183027_f() || settings.incompatibleResourcePacks.contains(resourcepackrepository$entry.getResourcePackName())) {
    ...
    public void updateRepositoryEntriesAll() {
        ...
        for (File file1 : this.getResourcePackFiles()) {
            ...
            if (!this.repositoryEntriesAll.contains(resourcepackrepository$entry)) {
                ...
                if (-1 < i && i < this.repositoryEntriesAll.size()) {
    ...
    public ListenableFuture<Object> downloadResourcePack(String url, String hash) {
        ...
        try {
            ...
            if (file1.exists() && 40 == hash.length()) {
                try {
    ...
    public class Entry {
        ...
        public void bindTexturePackIcon(TextureManager textureManagerIn) {
            if (null == locationTexturePackIcon) {
        ...
        public String getTexturePackDescription() {
            return null == rePackMetadataSection ? EnumChatFormatting.RED + "Invalid pack.mcmeta (or missing 'pack' section)" : this.rePackMetadataSection.getPackDescription().getFormattedText();
        }
