...
public class SimpleResource implements IResource {
    ...
    public <T extends IMetadataSection> T getMetadata(String p_110526_1_) {
        if (!this.hasMetadata()) {
            ...
            if (null == mcmetaJson && !this.mcmetaJsonChecked) {
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            if (null != srResourceLocation) {
                if (!this.srResourceLocation.equals(simpleresource.srResourceLocation)) {
                    return false;
                }
            } else if (null != simpleresource.srResourceLocation) {
                return false;
            }

            if (null != resourcePackName) {
                return this.resourcePackName.equals(simpleresource.resourcePackName);
            } else return null == simpleresource.resourcePackName;
        }
    }

    public int hashCode() {
        int i = null != resourcePackName ? this.resourcePackName.hashCode() : 0;
        i = 31 * i + (null != srResourceLocation ? this.srResourceLocation.hashCode() : 0);
        return i;
    }
}