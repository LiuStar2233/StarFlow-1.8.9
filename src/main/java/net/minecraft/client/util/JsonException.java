...
public class JsonException extends IOException {
    ...
    public static class Entry {
        ...
        public String toString() {
            return null != field_151376_a ? (!this.field_151375_b.isEmpty() ? this.field_151376_a + " " + this.func_151372_b() : this.field_151376_a) : (!this.field_151375_b.isEmpty() ? "(Unknown file) " + this.func_151372_b() : "(Unknown file)");
        }
    }
}