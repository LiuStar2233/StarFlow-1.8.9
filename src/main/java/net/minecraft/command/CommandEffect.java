...
public class CommandEffect extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (2 > args.length) {
            ...
            if ("clear".equals(args[1])) {
                ...
                if (0 <= i && i < Potion.potionTypes.length && null != Potion.potionTypes[i]) {
                    ...
                    boolean flag = 5 > args.length || !"true".equalsIgnoreCase(args[4]);
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return 1 == args.length ? getListOfStringsMatchingLastWord(args, this.getAllUsernames()) : (2 == args.length ? getListOfStringsMatchingLastWord(args, Potion.getPotionLocations()) : (5 == args.length ? getListOfStringsMatchingLastWord(args, "true", "false") : null));
    }
