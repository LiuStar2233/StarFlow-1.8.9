...
public class CommandEnchant extends CommandBase {
                    ...
                    if (itemstack.hasTagCompound()) {
                        ...
                        if (null != nbttaglist) {
                            for (int k = 0; k < nbttaglist.tagCount(); ++k) {
                                ...
                                if (null != Enchantment.getEnchantmentById(l)) {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return 1 == args.length ? getListOfStringsMatchingLastWord(args, this.getListOfPlayers()) : (2 == args.length ? getListOfStringsMatchingLastWord(args, Enchantment.func_181077_c()) : null);
    }
