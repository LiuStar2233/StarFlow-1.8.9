...
public class CommandParticle extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (8 > args.length) {
            ...
            if (!flag) {
                ...
                boolean flag1 = 9 < args.length && "force".equals(args[9]);
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return 1 == args.length ? getListOfStringsMatchingLastWord(args, EnumParticleTypes.getParticleNames()) : (1 < args.length && 4 >= args.length ? func_175771_a(args, 1, pos) : (10 == args.length ? getListOfStringsMatchingLastWord(args, "normal", "force") : null));
    }
}