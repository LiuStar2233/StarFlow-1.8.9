...
public abstract class CommandBlockLogic implements ICommandSender {
    ...
    public void writeDataToNBT(NBTTagCompound tagCompound) {
        ...
        if (null != lastOutput && this.trackOutput) {
    ...
    public void trigger(World worldIn) {
        ...
        if (null != minecraftserver && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled()) {
    ...
    public void addChatMessage(IChatComponent component) {
        if (this.trackOutput && null != getEntityWorld() && !this.getEntityWorld().isRemote) {
    ...
    public boolean sendCommandFeedback() {
        MinecraftServer minecraftserver = MinecraftServer.getServer();
        return null == minecraftserver || !minecraftserver.isAnvilFileSet() || minecraftserver.worldServers[0].getGameRules().getBoolean("commandBlockOutput");
    }
