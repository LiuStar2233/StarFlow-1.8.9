...
public class CommandScoreboard extends CommandBase {
            ...
            if (1 > args.length) {
                ...
                if ("objectives".equalsIgnoreCase(args[0])) {
                    ...
                    if ("list".equalsIgnoreCase(args[1])) {
                        ...
                        if (4 > args.length && (3 != args.length || !(sender instanceof EntityPlayer))) {
                        ...
                        if (3 > args.length && !(sender instanceof EntityPlayer)) {
    ...
    protected void setTeamOption(ICommandSender sender, String[] args, int index) throws CommandException {
        ...
        if (null != scoreplayerteam) {
            ...
            if (!"color".equalsIgnoreCase(s) && !"friendlyfire".equalsIgnoreCase(s) && !"seeFriendlyInvisibles".equalsIgnoreCase(s) && !"nametagVisibility".equalsIgnoreCase(s) && !"deathMessageVisibility".equalsIgnoreCase(s)) {
                throw new WrongUsageException("commands.scoreboard.teams.option.usage");
                ...
                if ("color".equalsIgnoreCase(s)) {
                    ...
                    if (null == enumchatformatting || enumchatformatting.isFancyStyling()) {
                        throw new WrongUsageException("commands.scoreboard.teams.option.noValue", s, joinNiceStringFromCollection(EnumChatFormatting.getValidValues(true, false)));
                    }
    ...
    protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
        ...
        if (p_147186_2_.length > p_147186_3_) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.teams.list.player.count", Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName());
            ...
            if (0 >= collection1.size()) {
                throw new CommandException("commands.scoreboard.teams.list.empty");
            }

            ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("commands.scoreboard.teams.list.count", Integer.valueOf(collection1.size()));
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147186_1_.addChatMessage(chatcomponenttranslation1);

            for (ScorePlayerTeam scoreplayerteam1 : collection1) {
                p_147186_1_.addChatMessage(new ChatComponentTranslation("commands.scoreboard.teams.list.entry", scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size())));
            }
        }
    }
    ...
    protected void emptyTeam(ICommandSender p_147188_1_, String[] p_147188_2_, int p_147188_3_) throws CommandException {
        ...
        if (null != scoreplayerteam) {
            ...
            if (collection.isEmpty()) {
                ...
                notifyOperators(p_147188_1_, this, "commands.scoreboard.teams.empty.success", Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName());
            }
        }
    }
    ...
    protected void listObjectives(ICommandSender p_147196_1_) throws CommandException {
        ...
        if (0 >= collection.size()) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.objectives.list.count", Integer.valueOf(collection.size()));
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
    ...
    protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException {
        ...
        if (p_147195_2_.length > p_147195_3_) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.players.list.player.count", Integer.valueOf(map.size()), s);
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147195_1_.addChatMessage(chatcomponenttranslation);

            for (Score score : map.values()) {
                p_147195_1_.addChatMessage(new ChatComponentTranslation("commands.scoreboard.players.list.player.entry", Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName()));
            }
        } else {
            ...
            ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("commands.scoreboard.players.list.count", Integer.valueOf(collection.size()));
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
    ...
    protected void setPlayer(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_) throws CommandException {
        ...
        if (40 < s1.length()) {
            ...
            int j = "set".equalsIgnoreCase(s) ? parseInt(p_147197_2_[p_147197_3_++]) : parseInt(p_147197_2_[p_147197_3_++], 0);
            ...
            notifyOperators(p_147197_1_, this, "commands.scoreboard.players.set.success", scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints()));
        }
    }
    ...
    protected void func_175781_o(ICommandSender p_175781_1_, String[] p_175781_2_, int p_175781_3_) throws CommandException {
        ...
        if (40 < s.length()) {
            ...
            if (!scoreboard.entityHasObjective(s, scoreobjective)) {
                ...
                int i = "*".equals(p_175781_2_[p_175781_3_]) ? Integer.MIN_VALUE : parseInt(p_175781_2_[p_175781_3_]);
                ++p_175781_3_;
                int j = p_175781_3_ < p_175781_2_.length && !"*".equals(p_175781_2_[p_175781_3_]) ? parseInt(p_175781_2_[p_175781_3_], i) : Integer.MAX_VALUE;
                Score score = scoreboard.getValueFromObjective(s, scoreobjective);

                if (score.getScorePoints() >= i && score.getScorePoints() <= j) {
                    notifyOperators(p_175781_1_, this, "commands.scoreboard.players.test.success", Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j));
                } else {
                    throw new CommandException("commands.scoreboard.players.test.failed", Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j));
                }
            }
        }
    }
            ...
            if ("objectives".equalsIgnoreCase(args[0])) {
                ...
                if (!"set".equalsIgnoreCase(args[1]) && !"add".equalsIgnoreCase(args[1]) && !"remove".equalsIgnoreCase(args[1]) && !"reset".equalsIgnoreCase(args[1])) {
                    if ("enable".equalsIgnoreCase(args[1])) {
                        ...
                        if (4 == args.length && "test".equalsIgnoreCase(args[1])) {
                            return getListOfStringsMatchingLastWord(args, this.func_147184_a(false));
                        }
                    }
                } else {
    ...
    public boolean isUsernameIndex(String[] args, int index) {
        return !"players".equalsIgnoreCase(args[0]) ? ("teams".equalsIgnoreCase(args[0]) && 2 == index) : (1 < args.length && "operation".equalsIgnoreCase(args[1]) ? 2 == index || 5 == index : 2 == index);
    }
}