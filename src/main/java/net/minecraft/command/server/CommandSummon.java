...
public class CommandSummon extends CommandBase {
        ...
        if (1 > args.length) {
            ...
            if (!world.isBlockLoaded(blockpos)) {
                ...
                if (null == entity2) {
                    ...
                    for (NBTTagCompound nbttagcompound1 = nbttagcompound; null != entity && nbttagcompound1.hasKey("Riding", 10); nbttagcompound1 = nbttagcompound1.getCompoundTag("Riding")) {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return 1 == args.length ? getListOfStringsMatchingLastWord(args, EntityList.getEntityNameList()) : (1 < args.length && 4 >= args.length ? func_175771_a(args, 1, pos) : null);
    }
}