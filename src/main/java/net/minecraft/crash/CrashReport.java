...
public class CrashReport {
    ...
    public void getSectionsInStringBuilder(StringBuilder builder) {
        if ((null == stacktrace || 0 >= stacktrace.length) && 0 < crashReportSections.size()) {
    ...
    public CrashReportCategory makeCategoryDepth(String categoryName, int stacktraceLength) {
        ...
        if (this.firstCategoryInCrashReport) {
            ...
            if (null != astacktraceelement && 0 <= j && j < astacktraceelement.length) {
            ...
            if (0 < i && !this.crashReportSections.isEmpty()) {
            ...
            } else if (null != astacktraceelement && astacktraceelement.length >= i && 0 <= j && j < astacktraceelement.length) {
