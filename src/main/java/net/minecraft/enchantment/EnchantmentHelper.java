...
public class EnchantmentHelper {
        ...
        if (null != stack) {
            ...
            if (null != nbttaglist) {
                for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                    ...
                    if (null != Enchantment.getEnchantmentById(j)) {
    ...
    public static int getEnchantmentModifierDamage(ItemStack[] stacks, DamageSource source) {
        ...
        if (25 < EnchantmentHelper.enchantmentModifierDamage.damageModifier) {
            enchantmentModifierDamage.damageModifier = 25;
        } else if (0 > EnchantmentHelper.enchantmentModifierDamage.damageModifier) {
            enchantmentModifierDamage.damageModifier = 0;
        }
    ...
    public static boolean getSilkTouchModifier(EntityLivingBase player) {
        return 0 < EnchantmentHelper.getEnchantmentLevel(Enchantment.silkTouch.effectId, player.getHeldItem());
    }
    ...
    public static boolean getAquaAffinityModifier(EntityLivingBase player) {
        return 0 < EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.aquaAffinity.effectId, player.getInventory());
    }
    ...
    public static ItemStack getEnchantedItem(Enchantment p_92099_0_, EntityLivingBase p_92099_1_) {
        for (ItemStack itemstack : p_92099_1_.getInventory()) {
            if (null != itemstack && 0 < EnchantmentHelper.getEnchantmentLevel(p_92099_0_.effectId, itemstack)) {
                return itemstack;
            }
        }
    ...
    public static int calcItemStackEnchantability(Random rand, int enchantNum, int power, ItemStack stack) {
        ...
        if (0 >= i) {
            ...
            return 0 == enchantNum ? Math.max(j / 3, 1) : (1 == enchantNum ? j * 2 / 3 + 1 : Math.max(j, power * 2));
        }
    }
    ...
    public static Map<Integer, EnchantmentData> mapEnchantmentData(int p_77505_0_, ItemStack p_77505_1_) {
        ...
        for (Enchantment enchantment : Enchantment.enchantmentsBookList) {
            if (null != enchantment && (enchantment.type.canEnchantItem(item) || flag)) {
