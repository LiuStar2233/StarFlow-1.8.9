...
public abstract class EntityCreature extends EntityLiving {
    ...
    public boolean getCanSpawnHere() {
        return super.getCanSpawnHere() && 0.0F <= getBlockPathWeight(new BlockPos(posX, getEntityBoundingBox().minY, posZ));
    }
    ...
    public boolean isWithinHomeDistanceFromPosition(BlockPos pos) {
        return -1.0F == maximumHomeDistance || this.homePosition.distanceSq(pos) < (double) (this.maximumHomeDistance * this.maximumHomeDistance);
    }
    ...
    public boolean hasHome() {
        return -1.0F != maximumHomeDistance;
    }
    ...
    protected void updateLeashedState() {
        ...
        if (this.getLeashed() && null != getLeashedToEntity() && this.getLeashedToEntity().worldObj == this.worldObj) {
