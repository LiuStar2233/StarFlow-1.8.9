...
public class EntityList {
    ...
    public static int getIDFromString(String entityName) {
        ...
        return null == integer ? 90 : integer.intValue();
    }
    ...
    public static List<String> getEntityNameList() {
        ...
        for (String s : set) {
            ...
            if (1024 != (oclass.getModifiers() & 1024)) {
                list.add(s);
            }
        }
    ...
    public static boolean isStringEntityName(Entity entityIn, String entityName) {
        ...
        if (null == s && entityIn instanceof EntityPlayer) {
            s = "Player";
        } else if (null == s && entityIn instanceof EntityLightningBolt) {
            s = "LightningBolt";
        }
