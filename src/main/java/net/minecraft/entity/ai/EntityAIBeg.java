...
public class EntityAIBeg extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        return null != thePlayer && this.hasPlayerGotBoneInHand(this.thePlayer);
    }
    ...
    public boolean continueExecuting() {
        return this.thePlayer.isEntityAlive() && (!(this.theWolf.getDistanceSqToEntity(this.thePlayer) > (double) (this.minPlayerDistance * this.minPlayerDistance)) && 0 < timeoutCounter && this.hasPlayerGotBoneInHand(this.thePlayer));
    }
    ...
    private boolean hasPlayerGotBoneInHand(EntityPlayer player) {
        ...
        return null != itemstack && (!this.theWolf.isTamed() && itemstack.getItem() == Items.bone || this.theWolf.isBreedingItem(itemstack));
    }
}