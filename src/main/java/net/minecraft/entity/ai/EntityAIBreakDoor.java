...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
    ...
    public boolean continueExecuting() {
        ...
        if (240 >= breakingTime) {
            ...
            if (!BlockDoor.isOpen(this.theEntity.worldObj, this.doorPosition) && 4.0D > d0) {
                flag = true;
                return flag;
            }
        }
    ...
    public void updateTask() {
        ...
        if (0 == theEntity.getRNG().nextInt(20)) {
        ...
        if (240 == breakingTime && EnumDifficulty.HARD == theEntity.worldObj.getDifficulty()) {
