...
public class EntityAIControlledByPlayer extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        return this.thisEntity.isEntityAlive() && null != thisEntity.riddenByEntity && this.thisEntity.riddenByEntity instanceof EntityPlayer && (this.speedBoosted || this.thisEntity.canBeSteered());
    }
    ...
    public void updateTask() {
        ...
        if (!entityplayer.capabilities.isCreativeMode && this.currentSpeed >= this.maxSpeed * 0.5F && 0.006F > thisEntity.getRNG().nextFloat() && !this.speedBoosted) {
            ItemStack itemstack = entityplayer.getHeldItem();

            if (null != itemstack && itemstack.getItem() == Items.carrot_on_a_stick) {
