            ...
            if (0 >= --field_75343_h) {
                ...
                if (!this.petPathfinder.tryMoveToEntityLiving(this.theOwner, this.followSpeed)) {
                    if (!this.thePet.getLeashed()) {
                        if (144.0D <= thePet.getDistanceSqToEntity(theOwner)) {
                            ...
                            for (int l = 0; 4 >= l; ++l) {
                                for (int i1 = 0; 4 >= i1; ++i1) {
                                    if ((1 > l || 1 > i1 || 3 < l || 3 < i1) && World.doesBlockHaveSolidTopSurface(this.theWorld, new BlockPos(i + l, k - 1, j + i1)) && this.func_181065_a(new BlockPos(i + l, k, j + i1)) && this.func_181065_a(new BlockPos(i + l, k + 1, j + i1))) {
