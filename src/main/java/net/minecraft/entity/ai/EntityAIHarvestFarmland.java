...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock {
    ...
    public boolean continueExecuting() {
        return 0 <= field_179501_f && super.continueExecuting();
    }
    ...
    public void updateTask() {
        ...
        if (this.getIsAboveDestination()) {
            ...
            if (0 == field_179501_f && block instanceof BlockCrops && 7 == iblockstate.getValue(BlockCrops.AGE).intValue()) {
                world.destroyBlock(blockpos, true);
            } else if (1 == field_179501_f && block == Blocks.air) {
    ...
    protected boolean shouldMoveTo(World worldIn, BlockPos pos) {
        ...
        if (block == Blocks.farmland) {
            ...
            if (block instanceof BlockCrops && 7 == iblockstate.getValue(BlockCrops.AGE).intValue() && this.field_179503_e && (0 == field_179501_f || 0 > field_179501_f)) {
                this.field_179501_f = 0;
                return true;
            }

            if (block == Blocks.air && this.hasFarmItem && (1 == field_179501_f || 0 > field_179501_f)) {
                this.field_179501_f = 1;
                return true;
            }
        }
