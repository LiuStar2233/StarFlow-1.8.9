...
public class EntityAIMate extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        return this.targetMate.isEntityAlive() && this.targetMate.isInLove() && 60 > spawnBabyDelay;
    }
    ...
    public void updateTask() {
        ...
        if (60 <= spawnBabyDelay && 9.0D > theAnimal.getDistanceSqToEntity(targetMate)) {
            this.spawnBaby();
        }
    }
    ...
    private void spawnBaby() {
        ...
        if (null != entityageable) {
            ...
            if (null == entityplayer && null != targetMate.getPlayerInLove()) {
