...
public class ModifiableAttributeInstance implements IAttributeInstance {
    ...
    public boolean hasModifier(AttributeModifier modifier) {
        return null != mapByUUID.get(modifier.getID());
    }

    public void applyModifier(AttributeModifier modifier) {
        if (null != getModifier(modifier.getID())) {
    ...
    private Collection<AttributeModifier> func_180375_b(int operation) {
        ...
        for (IAttribute iattribute = this.genericAttribute.func_180372_d(); null != iattribute; iattribute = iattribute.func_180372_d()) {
