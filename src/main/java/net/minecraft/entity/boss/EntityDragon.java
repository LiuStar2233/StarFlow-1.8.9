...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
    ...
    public void onLivingUpdate() {
        if (this.worldObj.isRemote) {
            ...
            if (-0.3F >= f1 && -0.3F <= f && !this.isSilent()) {
        ...
        if (0.0F >= getHealth()) {
            ...
            if (this.isAIDisabled()) {
                ...
                if (this.worldObj.isRemote) {
                    ...
                    if (this.forceNewTarget || 100.0D > d14 || 22500.0D < d14 || this.isCollidedHorizontally || this.isCollidedVertically) {
                        this.setNewTarget();
                    }

                    d12 = d12 / (double) MathHelper.sqrt_double(d11 * d11 + d13 * d13);
                    final float f17 = 0.6F;
                ...
                if (!this.worldObj.isRemote && 0 == hurtTime) {
    ...
    private void updateDragonEnderCrystal() {
        if (null != healingEnderCrystal) {
            ...
            } else if (0 == ticksExisted % 10 && this.getHealth() < this.getMaxHealth()) {
    ...
    private void setNewTarget() {
        ...
        if (0 == rand.nextInt(2) && !list.isEmpty()) {
            ...
            while (true) {
                ...
                boolean flag = 100.0D < d0 * d0 + d1 * d1 + d2 * d2;
    ...
    protected void onDeathUpdate() {
        ...
        if (180 <= deathTicks && 200 >= deathTicks) {
        ...
        if (!this.worldObj.isRemote) {
            if (150 < deathTicks && 0 == deathTicks % 5 && flag) {
                int i = 1000;
        ...
        if (200 == deathTicks && !this.worldObj.isRemote) {
            if (flag) {
                int j = 2000;
    ...
    private void generatePortal(BlockPos pos) {
        final int i = 4;
        final double d0 = 12.25D;
        final double d1 = 6.25D;
