...
public class EntityGhast extends EntityFlying implements IMob {
    ...
    public boolean isAttacking() {
        return 0 != dataWatcher.getWatchableObjectByte(16);
    }
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.isRemote && EnumDifficulty.PEACEFUL == worldObj.getDifficulty()) {
            this.setDead();
        }
    }
    ...
    public boolean getCanSpawnHere() {
        return 0 == rand.nextInt(20) && super.getCanSpawnHere() && EnumDifficulty.PEACEFUL != worldObj.getDifficulty();
    }
    ...
    static class AIFireballAttack extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            return null != parentEntity.getAttackTarget();
        }
        ...
        public void updateTask() {
            ...
            if (d0 * d0 > entitylivingbase.getDistanceSqToEntity(parentEntity) && this.parentEntity.canEntityBeSeen(entitylivingbase)) {
            ...
            } else if (0 < attackTimer) {
                --this.attackTimer;
            }

            this.parentEntity.setAttacking(10 < attackTimer);
        }
    }
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public void updateTask() {
            if (null == parentEntity.getAttackTarget()) {
                ...
                if (d0 * d0 > entitylivingbase.getDistanceSqToEntity(parentEntity)) {
