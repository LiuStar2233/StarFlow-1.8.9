...
public abstract class EntityMob extends EntityCreature implements IMob {
    ...
    protected String getFallSoundString(int damageValue) {
        return 4 < damageValue ? "game.hostile.hurt.fall.big" : "game.hostile.hurt.fall.small";
    }
    ...
    public boolean getCanSpawnHere() {
        return EnumDifficulty.PEACEFUL != worldObj.getDifficulty() && this.isValidLightLevel() && super.getCanSpawnHere();
    }
