...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (1.0F < worldObj.getBiomeGenForCoords(new BlockPos(i, 0, k)).getFloatTemperature(new BlockPos(i, j, k))) {
            ...
            for (int l = 0; 4 > l; ++l) {
                ...
                if (this.worldObj.getBlockState(blockpos).getBlock().getMaterial() == Material.air && 0.8F > worldObj.getBiomeGenForCoords(new BlockPos(i, 0, k)).getFloatTemperature(blockpos) && Blocks.snow_layer.canPlaceBlockAt(this.worldObj, blockpos)) {
