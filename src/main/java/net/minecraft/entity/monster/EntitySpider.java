...
public class EntitySpider extends EntityMob {
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier) {
        ...
        if (wasRecentlyHit && (0 == rand.nextInt(3) || 0 < rand.nextInt(1 + lootingModifier))) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (0 == worldObj.rand.nextInt(100)) {
        ...
        if (null == livingdata) {
            ...
            if (EnumDifficulty.HARD == worldObj.getDifficulty() && this.worldObj.rand.nextFloat() < 0.1F * difficulty.getClampedAdditionalDifficulty()) {
        ...
        if (livingdata instanceof EntitySpider.GroupData) {
            ...
            if (0 < i && null != Potion.potionTypes[i]) {
    ...
    static class AISpiderAttack extends EntityAIAttackOnCollide {
        ...
        public boolean continueExecuting() {
            ...
            if (0.5F <= f && 0 == attacker.getRNG().nextInt(100)) {
    ...
    static class AISpiderTarget<T extends EntityLivingBase> extends EntityAINearestAttackableTarget {
        ...
        public boolean shouldExecute() {
            ...
            return !(0.5F <= f) && super.shouldExecute();
        }
    }
