...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals {
    ...
    public boolean getCanSpawnHere() {
        ...
        return this.worldObj.getBlockState(blockpos.down()).getBlock() == this.spawnableBlock && 8 < worldObj.getLight(blockpos) && super.getCanSpawnHere();
    }
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return null != stack && stack.getItem() == Items.wheat;
    }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (null != itemstack) {
            if (this.isBreedingItem(itemstack) && 0 == getGrowingAge() && 0 >= inLove) {
