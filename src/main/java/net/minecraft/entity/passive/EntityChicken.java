...
public class EntityChicken extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        ...
        if (!this.onGround && 1.0F > wingRotDelta) {
        ...
        if (!this.worldObj.isRemote && !this.isChild() && !this.isChickenJockey() && 0 >= --timeUntilNextEgg) {
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return null != stack && stack.getItem() == Items.wheat_seeds;
    }
    ...
    protected boolean canDespawn() {
        return this.isChickenJockey() && null == riddenByEntity;
    }
