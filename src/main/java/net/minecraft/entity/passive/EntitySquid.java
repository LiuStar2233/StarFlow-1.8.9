...
public class EntitySquid extends EntityWaterMob {
    ...
    public void onLivingUpdate() {
        ...
        if ((Math.PI * 2D) < (double) squidRotation) {
        ...
        if (this.inWater) {
            if ((float) Math.PI > squidRotation) {
    ...
    public boolean getCanSpawnHere() {
        return 45.0D < posY && this.posY < (double) this.worldObj.getSeaLevel() && super.getCanSpawnHere();
    }
    ...
    public boolean func_175567_n() {
        return 0.0F != randomMotionVecX || 0.0F != randomMotionVecY || 0.0F != randomMotionVecZ;
    }
    ...
    static class AIMoveRandom extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            } else if (0 == squid.getRNG().nextInt(50) || !this.squid.inWater || !this.squid.func_175567_n()) {
