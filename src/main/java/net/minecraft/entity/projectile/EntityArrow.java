...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public void onUpdate() {
        ...
        if (block.getMaterial() != Material.air) {
            ...
            if (null != axisalignedbb && axisalignedbb.isVecInside(new Vec3(this.posX, this.posY, this.posZ))) {
                this.inGround = true;
            }
        }
        ...
        if (this.inGround) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity1.canBeCollidedWith() && (entity1 != this.shootingEntity || 5 <= ticksInAir)) {
                    final float f1 = 0.3F;
            ...
            if (null != movingobjectposition && null != movingobjectposition.entityHit && movingobjectposition.entityHit instanceof EntityPlayer) {
                ...
                if (null != movingobjectposition.entityHit) {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float) l)) {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                            ...
                            if (null != shootingEntity && movingobjectposition.entityHit != this.shootingEntity && movingobjectposition.entityHit instanceof EntityPlayer && this.shootingEntity instanceof EntityPlayerMP) {
            ...
            for (this.rotationPitch = (float) (MathHelper.atan2(this.motionY, f3) * 180.0D / Math.PI); -180.0F > rotationPitch - prevRotationPitch; this.prevRotationPitch -= 360.0F) {
            }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.worldObj.isRemote && this.inGround && 0 >= arrowShake) {
            boolean flag = 1 == canBePickedUp || 2 == canBePickedUp && entityIn.capabilities.isCreativeMode;

            if (1 == canBePickedUp && !entityIn.inventory.addItemStackToInventory(new ItemStack(Items.arrow, 1))) {
                flag = false;
            }
