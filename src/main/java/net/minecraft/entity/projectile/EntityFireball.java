...
public abstract class EntityFireball extends Entity {
    ...
    public void onUpdate() {
        if (this.worldObj.isRemote || (null == shootingEntity || !this.shootingEntity.isDead) && this.worldObj.isBlockLoaded(new BlockPos(this))) {
            super.onUpdate();
            this.setFire(1);
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity1.canBeCollidedWith() && (!entity1.isEntityEqual(this.shootingEntity) || 25 <= ticksInAir)) {
                    final float f = 0.3F;
            ...
            for (this.rotationPitch = (float) (MathHelper.atan2(f1, this.motionY) * 180.0D / Math.PI) - 90.0F; -180.0F > rotationPitch - prevRotationPitch; this.prevRotationPitch -= 360.0F) {
            }
