...
public class ContainerBrewingStand extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (null != slot && slot.getHasStack()) {
            ...
            if ((0 > index || 2 < index) && 3 != index) {
                ...
                } else if (4 <= index && 31 > index) {
                    if (!this.mergeItemStack(itemstack1, 31, 40, false)) {
                        return null;
                    }
                } else if (31 <= index && 40 > index) {
    ...
    class Ingredient extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return null != stack && stack.getItem().isPotionIngredient(stack);
        }
    ...
    static class Potion extends Slot {
        ...
        public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
            if (stack.getItem() == Items.potionitem && 0 < stack.getMetadata()) {
        ...
        public static boolean canHoldPotion(ItemStack stack) {
            return null != stack && (stack.getItem() == Items.potionitem || stack.getItem() == Items.glass_bottle);
        }
    }
}