...
public class ContainerHorseInventory extends Container {
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        return this.horseInventory.isUseableByPlayer(playerIn) && this.theHorse.isEntityAlive() && 8.0F > theHorse.getDistanceToEntity(playerIn);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (null != slot && slot.getHasStack()) {
            ...
            } else if (2 >= horseInventory.getSizeInventory() || !this.mergeItemStack(itemstack1, 2, this.horseInventory.getSizeInventory(), false)) {
                return null;
            }
