...
public class ContainerRepair extends Container {
    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player) {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(EntityPlayer playerIn) {
                return (playerIn.capabilities.isCreativeMode || playerIn.experienceLevel >= ContainerRepair.this.maximumCost) && 0 < maximumCost && this.getHasStack();
            }
            ...
            public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
                ...
                if (0 < materialCost) {
                    ...
                    if (null != itemstack && itemstack.stackSize > ContainerRepair.this.materialCost) {
                ...
                if (!playerIn.capabilities.isCreativeMode && !worldIn.isRemote && iblockstate.getBlock() == Blocks.anvil && 0.12F > playerIn.getRNG().nextFloat()) {
    ...
    public void updateRepairOutput() {
        ...
        if (null == itemstack) {
            ...
            boolean flag = false;
            i2 = i2 + itemstack.getRepairCost() + (null == itemstack2 ? 0 : itemstack2.getRepairCost());
            this.materialCost = 0;

            if (null != itemstack2) {
                flag = itemstack2.getItem() == Items.enchanted_book && 0 < Items.enchanted_book.getEnchantments(itemstack2).tagCount();
                ...
                if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
                    ...
                    for (l4 = 0; 0 < j4 && l4 < itemstack2.stackSize; ++l4) {
            ...
            if (j2 == l1 && 0 < j2 && 40 <= maximumCost) {
                this.maximumCost = 39;
            }

            if (40 <= maximumCost && !this.thePlayer.capabilities.isCreativeMode) {
                itemstack1 = null;
            }
            ...
            if (null != itemstack1) {
                ...
                if (null != itemstack2 && k4 < itemstack2.getRepairCost()) {
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        return this.theWorld.getBlockState(this.selfPosition).getBlock() == Blocks.anvil && 64.0D >= playerIn.getDistanceSq((double) selfPosition.getX() + 0.5D, (double) selfPosition.getY() + 0.5D, (double) selfPosition.getZ() + 0.5D);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (null != slot && slot.getHasStack()) {
            ...
            if (2 == index) {
                ...
                if (3 <= index && 39 > index && !this.mergeItemStack(itemstack1, 0, 2, false)) {
                    return null;
                }
