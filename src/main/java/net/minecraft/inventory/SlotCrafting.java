...
public class SlotCrafting extends Slot {
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if (stack.getItem() instanceof ItemPickaxe && Item.ToolMaterial.WOOD != ((ItemPickaxe) stack.getItem()).getToolMaterial()) {
        ...
        if (stack.getItem() == Items.golden_apple && 1 == stack.getMetadata()) {
    ...
    public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
        ...
        for (int i = 0; i < aitemstack.length; ++i) {
            ...
            if (null != itemstack1) {
                if (null == craftMatrix.getStackInSlot(i)) {
