...
public class SlotMerchantResult extends Slot {
    ...
    private boolean doTrade(MerchantRecipe trade, ItemStack firstItem, ItemStack secondItem) {
        ...
        if (null != firstItem && firstItem.getItem() == itemstack.getItem()) {
            if (null != itemstack1 && null != secondItem && itemstack1.getItem() == secondItem.getItem()) {
                firstItem.stackSize -= itemstack.stackSize;
                secondItem.stackSize -= itemstack1.stackSize;
                return true;
            }

            if (null == itemstack1 && null == secondItem) {
                firstItem.stackSize -= itemstack.stackSize;
                return true;
            }
        }
