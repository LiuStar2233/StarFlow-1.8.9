...
public class Item {
    ...
    public static int getIdFromItem(Item itemIn) {
        return null == itemIn ? 0 : itemRegistry.getIDForObject(itemIn);
    }
    ...
    public boolean isDamageable() {
        return 0 < maxDamage && !this.hasSubtypes;
    }
    ...
    public String getUnlocalizedNameInefficiently(ItemStack stack) {
        ...
        return null == s ? "" : StatCollector.translateToLocal(s);
    }
    ...
    public boolean isPotionIngredient(ItemStack stack) {
        return null != getPotionEffect(stack);
    }
    ...
    public boolean isItemTool(ItemStack stack) {
        return 1 == getItemStackLimit() && this.isDamageable();
    }
    ...
    public static void registerItems() {
        ...
        registerItemBlock(Blocks.sponge, (new ItemMultiTexture(Blocks.sponge, Blocks.sponge, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {
                return 1 == (p_apply_1_.getMetadata() & 1) ? "wet" : "dry";
            }
    ...
    public enum ToolMaterial {
        ...
        public Item getRepairItem() {
            return WOOD == this ? Item.getItemFromBlock(Blocks.planks) : (STONE == this ? Item.getItemFromBlock(Blocks.cobblestone) : (GOLD == this ? Items.gold_ingot : (IRON == this ? Items.iron_ingot : (EMERALD == this ? Items.diamond : null))));
        }
    }
}