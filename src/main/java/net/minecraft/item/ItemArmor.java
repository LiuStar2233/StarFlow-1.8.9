...
public class ItemArmor extends Item {
    ...
    public boolean hasColor(ItemStack stack) {
        return ArmorMaterial.LEATHER == material && (stack.hasTagCompound() && (stack.getTagCompound().hasKey("display", 10) && stack.getTagCompound().getCompoundTag("display").hasKey("color", 3)));
    }
    ...
    public int getColor(ItemStack stack) {
        if (ArmorMaterial.LEATHER != material) {
            return -1;
        } else {
            ...
            if (null != nbttagcompound) {
                ...
                if (null != nbttagcompound1 && nbttagcompound1.hasKey("color", 3)) {
    ...
    public enum ArmorMaterial {
        ...
        public Item getRepairItem() {
            return LEATHER == this ? Items.leather : (CHAIN == this ? Items.iron_ingot : (GOLD == this ? Items.gold_ingot : (IRON == this ? Items.iron_ingot : (DIAMOND == this ? Items.diamond : null))));
        }
