...
public class ItemDoublePlant extends ItemMultiTexture {
    ...
    public int getColorFromItemStack(ItemStack stack, int renderPass) {
        ...
        return BlockDoublePlant.EnumPlantType.GRASS != blockdoubleplant$enumplanttype && BlockDoublePlant.EnumPlantType.FERN != blockdoubleplant$enumplanttype ? super.getColorFromItemStack(stack, renderPass) : ColorizerGrass.getGrassColor(0.5D, 1.0D);
    }
}