...
public class ItemDye extends Item {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        return this.getUnlocalizedName() + "." + EnumDyeColor.byDyeDamage(i).getUnlocalizedName();
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!playerIn.canPlayerEdit(pos.offset(side), side, stack)) {
            ...
            if (EnumDyeColor.WHITE == enumdyecolor) {
            ...
            } else if (EnumDyeColor.BROWN == enumdyecolor) {
                IBlockState iblockstate = worldIn.getBlockState(pos);
                Block block = iblockstate.getBlock();

                if (block == Blocks.log && BlockPlanks.EnumType.JUNGLE == iblockstate.getValue(BlockPlanks.VARIANT)) {
