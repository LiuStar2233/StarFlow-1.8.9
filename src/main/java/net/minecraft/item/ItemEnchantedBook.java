...
public class ItemEnchantedBook extends Item {
    ...
    public EnumRarity getRarity(ItemStack stack) {
        return 0 < getEnchantments(stack).tagCount() ? EnumRarity.UNCOMMON : super.getRarity(stack);
    }

    public NBTTagList getEnchantments(ItemStack stack) {
        NBTTagCompound nbttagcompound = stack.getTagCompound();
        return null != nbttagcompound && nbttagcompound.hasKey("StoredEnchantments", 9) ? (NBTTagList) nbttagcompound.getTag("StoredEnchantments") : new NBTTagList();
    }
