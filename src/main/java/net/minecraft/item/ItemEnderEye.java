...
public class ItemEnderEye extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        if (null != movingobjectposition && MovingObjectPosition.MovingObjectType.BLOCK == movingobjectposition.typeOfHit && worldIn.getBlockState(movingobjectposition.getBlockPos()).getBlock() == Blocks.end_portal_frame) {
            return itemStackIn;
        } else {
            if (!worldIn.isRemote) {
