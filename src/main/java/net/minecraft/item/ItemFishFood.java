...
public class ItemFishFood extends ItemFood {
    ...
    public String getPotionEffect(ItemStack stack) {
        return FishType.PUFFERFISH == FishType.byItemStack(stack) ? PotionHelper.pufferfishEffect : null;
    }

    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
        ItemFishFood.FishType itemfishfood$fishtype = ItemFishFood.FishType.byItemStack(stack);

        if (FishType.PUFFERFISH == itemfishfood$fishtype) {
    ...
    public enum FishType {
        ...
        public static ItemFishFood.FishType byMetadata(int meta) {
            ...
            return null == itemfishfood$fishtype ? COD : itemfishfood$fishtype;
        }
