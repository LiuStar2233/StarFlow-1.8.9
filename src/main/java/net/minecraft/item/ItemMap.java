...
public class ItemMap extends ItemMapBase {
    ...
    public MapData getMapData(ItemStack stack, World worldIn) {
        ...
        if (null == mapdata && !worldIn.isRemote) {
                    ...
                    for (int l1 = i1 - j1 - 1; l1 < i1 + j1; ++l1) {
                        if (0 <= k1 && -1 <= l1 && 128 > k1 && 128 > l1) {
                            ...
                            if (!chunk.isEmpty()) {
                                            ...
                                            if (1 < k4) {
                                                label541:
                                                {
                                                    while (true) {
                                                        ...
                                                        if (iblockstate.getBlock().getMapColor(iblockstate) != MapColor.airColor || 0 >= k4) {
                                                            break;
                                                        }
                                                    }

                                                    if (0 < k4 && iblockstate.getBlock().getMaterial().isLiquid()) {
                                                        int l4 = k4 - 1;
                                                        ...
                                                        while (true) {
                                                            ...
                                                            if (0 >= l4 || !block.getMaterial().isLiquid()) {
                                                                break label541;
                                                            }
                                                        }
                                                    }
                                ...
                                if (0 <= l1 && i2 * i2 + j2 * j2 < j1 * j1 && (!flag1 || 0 != (k1 + l1 & 1))) {
