...
public class ItemMonsterPlacer extends Item {
    ...
    public int getColorFromItemStack(ItemStack stack, int renderPass) {
        ...
        return null != entitylist$entityegginfo ? (0 == renderPass ? entitylist$entityegginfo.primaryColor : entitylist$entityegginfo.secondaryColor) : 16777215;
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (worldIn.isRemote) {
            ...
            if (EnumFacing.UP == side && iblockstate instanceof BlockFence) {
                d0 = 0.5D;
            }
    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        if (worldIn.isRemote) {
            ...
            if (null == movingobjectposition) {
                ...
                if (MovingObjectPosition.MovingObjectType.BLOCK == movingobjectposition.typeOfHit) {
