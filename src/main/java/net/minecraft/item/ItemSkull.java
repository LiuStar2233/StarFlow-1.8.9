...
public class ItemSkull extends Item {
                    ...
                    if (tileentity instanceof TileEntitySkull) {
                        ...
                        if (3 == stack.getMetadata()) {
                            ...
                            if (stack.hasTagCompound()) {
                                ...
                                } else if (nbttagcompound.hasKey("SkullOwner", 8) && 0 < nbttagcompound.getString("SkullOwner").length()) {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        if (0 > i || i >= skullTypes.length) {
            i = 0;
        }

        return this.getUnlocalizedName() + "." + skullTypes[i];
    }

    public String getItemStackDisplayName(ItemStack stack) {
        if (3 == stack.getMetadata() && stack.hasTagCompound()) {
    ...
    public boolean updateItemStackNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("SkullOwner", 8) && 0 < nbt.getString("SkullOwner").length()) {
