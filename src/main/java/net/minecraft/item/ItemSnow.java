...
public class ItemSnow extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (0 == stack.stackSize) {
            ...
            if ((EnumFacing.UP != side || block != this.block) && !block.isReplaceable(worldIn, pos)) {
            ...
            if (block == this.block) {
                ...
                if (7 >= i) {
                    ...
                    if (null != axisalignedbb && worldIn.checkNoEntityCollision(axisalignedbb) && worldIn.setBlockState(blockpos, iblockstate1, 2)) {
