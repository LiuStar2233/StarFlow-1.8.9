...
public final class ItemStack {
    ...
    public static ItemStack loadItemStackFromNBT(NBTTagCompound nbt) {
        ...
        return null != itemstack.getItem() ? itemstack : null;
    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
        ...
        nbt.setString("id", null == resourcelocation ? "minecraft:air" : resourcelocation.toString());
    ...
    public boolean isStackable() {
        return 1 < getMaxStackSize() && (!this.isItemStackDamageable() || !this.isItemDamaged());
    }
    ...
    public boolean isItemStackDamageable() {
        return null != item && (0 < item.getMaxDamage() && (!this.hasTagCompound() || !this.getTagCompound().getBoolean("Unbreakable")));
    }
    ...
    public boolean isItemDamaged() {
        return this.isItemStackDamageable() && 0 < itemDamage;
    }
            ...
            if (this.isItemStackDamageable()) {
                if (this.attemptDamageItem(amount, entityIn.getRNG())) {
                    ...
                    if (entityIn instanceof EntityPlayer) {
                        ...
                        if (0 == stackSize && this.getItem() instanceof ItemBow) {
    ...
    public static boolean areItemStackTagsEqual(ItemStack stackA, ItemStack stackB) {
        return null == stackA && null == stackB || (null != stackA && null != stackB && ((null != stackA.stackTagCompound || null == stackB.stackTagCompound) && (null == stackA.stackTagCompound || stackA.stackTagCompound.equals(stackB.stackTagCompound))));
    }
    ...
    public static boolean areItemStacksEqual(ItemStack stackA, ItemStack stackB) {
        return null == stackA && null == stackB || (null != stackA && null != stackB && stackA.isItemStackEqual(stackB));
    }
    ...
    private boolean isItemStackEqual(ItemStack other) {
        return this.stackSize == other.stackSize && (this.item == other.item && (this.itemDamage == other.itemDamage && ((null != stackTagCompound || null == other.stackTagCompound) && (null == stackTagCompound || this.stackTagCompound.equals(other.stackTagCompound)))));
    }
    ...
    public static boolean areItemsEqual(ItemStack stackA, ItemStack stackB) {
        return null == stackA && null == stackB || (null != stackA && stackA.isItemEqual(stackB));
    }
    ...
    public boolean isItemEqual(ItemStack other) {
        return null != other && this.item == other.item && this.itemDamage == other.itemDamage;
    }
    ...
    public NBTTagCompound getSubCompound(String key, boolean create) {
        if (null != stackTagCompound && this.stackTagCompound.hasKey(key, 10)) {
    ...
    public NBTTagList getEnchantmentTagList() {
        return null == stackTagCompound ? null : this.stackTagCompound.getTagList("ench", 10);
    }
    ...
    public String getDisplayName() {
        ...
        if (null != stackTagCompound && this.stackTagCompound.hasKey("display", 10)) {
    ...
    public boolean hasDisplayName() {
        return null != stackTagCompound && (this.stackTagCompound.hasKey("display", 10) && this.stackTagCompound.getCompoundTag("display").hasKey("Name", 8));
    }
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        if (this.hasTagCompound()) {
            if (0 == (i1 & 1)) {
                ...
                if (null != nbttaglist) {
                    for (int j = 0; j < nbttaglist.tagCount(); ++j) {
                        ...
                        if (null != Enchantment.getEnchantmentById(k)) {
            ...
            if (this.stackTagCompound.hasKey("display", 10)) {
                ...
                if (9 == nbttagcompound.getTagId("Lore")) {
                    NBTTagList nbttaglist1 = nbttagcompound.getTagList("Lore", 8);

                    if (0 < nbttaglist1.tagCount()) {
        ...
        if (!multimap.isEmpty() && 0 == (i1 & 2)) {
            ...
            for (Map.Entry<String, AttributeModifier> entry : multimap.entries()) {
                ...
                if (1 != attributemodifier.getOperation() && 2 != attributemodifier.getOperation()) {
                    d1 = d0;
                } else {
                    d1 = d0 * 100.0D;
                }
        ...
        if (this.hasTagCompound() && this.getTagCompound().getBoolean("Unbreakable") && 0 == (i1 & 4)) {
            list.add(EnumChatFormatting.BLUE + StatCollector.translateToLocal("item.unbreakable"));
        }

        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanDestroy", 9) && 0 == (i1 & 8)) {
            NBTTagList nbttaglist2 = this.stackTagCompound.getTagList("CanDestroy", 8);

            if (0 < nbttaglist2.tagCount()) {
                list.add("");
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanPlaceOn", 9) && 0 == (i1 & 16)) {
            NBTTagList nbttaglist3 = this.stackTagCompound.getTagList("CanPlaceOn", 8);

            if (0 < nbttaglist3.tagCount()) {
                list.add("");
    ...
    public boolean isItemEnchanted() {
        return null != stackTagCompound && this.stackTagCompound.hasKey("ench", 9);
    }
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers() {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("AttributeModifiers", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                if (null != attributemodifier && 0L != attributemodifier.getID().getLeastSignificantBits() && 0L != attributemodifier.getID().getMostSignificantBits()) {
