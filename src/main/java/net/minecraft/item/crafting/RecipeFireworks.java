            ...
            if (1 <= j && 1 == i && 0 == i1) {
                ...
                if (0 < l) {
                    ...
                    for (int k2 = 0; k2 < inv.getSizeInventory(); ++k2) {
                        ...
                        if (null != itemstack3 && itemstack3.getItem() == Items.firework_charge && itemstack3.hasTagCompound() && itemstack3.getTagCompound().hasKey("Explosion", 10)) {
