    ...
    static class RecipeAddPattern implements IRecipe {
        ...
        public boolean matches(InventoryCrafting inv, World worldIn) {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i) {
                ...
                if (null != itemstack && itemstack.getItem() == Items.banner) {
                    if (flag) {
                        return false;
                    }

                    if (6 <= TileEntityBanner.getPatterns(itemstack)) {
                        return false;
                    }
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv) {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i) {
                ...
                if (null != itemstack1 && itemstack1.getItem() == Items.banner) {
            ...
            if (null != tileentitybanner$enumbannerpattern) {
                int k = 0;

                for (int j = 0; j < inv.getSizeInventory(); ++j) {
                    ItemStack itemstack2 = inv.getStackInSlot(j);

                    if (null != itemstack2 && itemstack2.getItem() == Items.dye) {
        ...
        public ItemStack[] getRemainingItems(InventoryCrafting inv) {
            ...
            for (int i = 0; i < aitemstack.length; ++i) {
                ...
                if (null != itemstack && itemstack.getItem().hasContainerItem()) {
                    ...
                    if (tileentitybanner$enumbannerpattern.hasCraftingStack()) {
                        ...
                        for (int k = 0; k < p_179533_1_.getSizeInventory() && flag; ++k) {
                            ...
                            if (null != itemstack1 && itemstack1.getItem() != Items.banner) {
                                ...
                                if (-1 != j && j != itemstack1.getMetadata()) {
                                    flag = false;
                                    break;
                                }

                                if (32 == tileentitybanner$enumbannerpattern.getCraftingLayers()[l].charAt(i1)) {
                                    flag = false;
                                    break;
                                }

                                j = itemstack1.getMetadata();
                            } else if (32 != tileentitybanner$enumbannerpattern.getCraftingLayers()[l].charAt(i1)) {
                                flag = false;
                                break;
                            }
                        }
    ...
    static class RecipeDuplicatePattern implements IRecipe {
        ...
        public boolean matches(InventoryCrafting inv, World worldIn) {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i) {
                ...
                if (null != itemstack2) {
                    ...
                    if (null != itemstack && null != itemstack1) {
                        return false;
                    }

                    int j = TileEntityBanner.getBaseColor(itemstack2);
                    boolean flag = 0 < TileEntityBanner.getPatterns(itemstack2);
            ...
            return null != itemstack && null != itemstack1;
        }
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv) {
            for (int i = 0; i < inv.getSizeInventory(); ++i) {
                ...
                if (null != itemstack && 0 < TileEntityBanner.getPatterns(itemstack)) {
            ...
            for (int i = 0; i < aitemstack.length; ++i) {
                ...
                if (null != itemstack) {
                    if (itemstack.getItem().hasContainerItem()) {
                        aitemstack[i] = new ItemStack(itemstack.getItem().getContainerItem());
                    } else if (itemstack.hasTagCompound() && 0 < TileEntityBanner.getPatterns(itemstack)) {
