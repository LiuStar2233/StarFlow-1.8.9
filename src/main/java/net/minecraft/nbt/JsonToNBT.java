...
public class JsonToNBT {
    ...
    public static NBTTagCompound getTagFromJson(String jsonString) throws NBTException {
        ...
        } else if (1 != JsonToNBT.func_150310_b(jsonString)) {
    ...
    static int func_150310_b(String p_150310_0_) throws NBTException {
        ...
        for (int j = 0; j < p_150310_0_.length(); ++j) {
            ...
            if (34 == c0) {
                ...
                if (123 != c0 && 91 != c0) {
                    if (125 == c0 && (stack.isEmpty() || 123 != stack.pop().charValue())) {
                        throw new NBTException("Unbalanced curly brackets {}: " + p_150310_0_);
                    }

                    if (93 == c0 && (stack.isEmpty() || 91 != stack.pop().charValue())) {
    ...
    static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
        ...
        if (p_150316_1_.startsWith("{")) {
            ...
            for (jsontonbt$compound = new JsonToNBT.Compound(p_150316_0_); 0 < p_150316_1_.length(); p_150316_1_ = p_150316_1_.substring(s1.length() + 1)) {
                ...
                if (44 != c1 && 123 != c1 && 125 != c1 && 91 != c1 && 93 != c1) {
            ...
            for (jsontonbt$list = new JsonToNBT.List(p_150316_0_); 0 < p_150316_1_.length(); p_150316_1_ = p_150316_1_.substring(s.length() + 1)) {
                ...
                if (44 != c0 && 123 != c0 && 125 != c0 && 91 != c0 && 93 != c0) {
    ...
    private static boolean func_179271_b(String p_179271_0_, int p_179271_1_) {
        return 0 < p_179271_1_ && 92 == p_179271_0_.charAt(p_179271_1_ - 1) && !func_179271_b(p_179271_0_, p_179271_1_ - 1);
    }
        ...
        public NBTBase parse() throws NBTException {
            ...
            if (this.jsonValue.startsWith("[") && this.jsonValue.endsWith("]")) {
                ...
                for (int i = 0; i < this.jsonValue.length(); ++i) {
                    if (i < this.jsonValue.length() - 1 && 92 == jsonValue.charAt(i) && 92 == jsonValue.charAt(i + 1)) {
