...
public class IntegratedPlayerList extends ServerConfigurationManager {
    ...
    public String allowUserToConnect(SocketAddress address, GameProfile profile) {
        return profile.getName().equalsIgnoreCase(this.getServerInstance().getServerOwner()) && null != getPlayerByUsername(profile.getName()) ? "That name is already taken." : super.allowUserToConnect(address, profile);
    }
