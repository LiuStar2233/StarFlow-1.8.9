...
public class IntegratedServer extends MinecraftServer {
    ...
    protected void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String worldNameIn2) {
        ...
        if (null == worldServers[0].getWorldInfo().getDifficulty()) {
    ...
    public void tick() {
        ...
        this.isGamePaused = null != Minecraft.getMinecraft().getNetHandler() && Minecraft.getMinecraft().isGamePaused();
        ...
        report.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>() {
            public String call() throws Exception {
                ...
                if (!"vanilla".equals(s)) {
                    ...
                    return !"vanilla".equals(s) ? "Definitely; Server brand changed to '" + s + "'" : (null == Minecraft.class.getSigners() ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and both client + server brands are untouched.");
                }
            }
        });
        return report;
