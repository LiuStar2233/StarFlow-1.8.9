...
public class PlayerManager {
    ...
    public void updatePlayerInstances() {
        ...
        if (8000L < i - previousTotalWorldTime) {
    ...
    public boolean hasPlayerInstance(int chunkX, int chunkZ) {
        ...
        return null != playerInstances.getValueByKey(i);
    }
    ...
    private PlayerManager.PlayerInstance getPlayerInstance(int chunkX, int chunkZ, boolean createIfAbsent) {
        ...
        if (null == playermanager$playerinstance && createIfAbsent) {
    ...
    public void markBlockForUpdate(BlockPos pos) {
        ...
        if (null != playermanager$playerinstance) {
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP player, int chunkX, int chunkZ) {
        ...
        return null != playermanager$playerinstance && playermanager$playerinstance.playersWatchingChunk.contains(player) && !player.loadedChunks.contains(playermanager$playerinstance.chunkCoords);
    }
