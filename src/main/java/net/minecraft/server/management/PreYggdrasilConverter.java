    ...
    public static String getStringUUIDFromName(String p_152719_0_) {
        if (!StringUtils.isNullOrEmpty(p_152719_0_) && 16 >= p_152719_0_.length()) {
            ...
            if (null != gameprofile && null != gameprofile.getId()) {
                ...
                return 0 < list.size() && null != list.get(0).getId() ? list.get(0).getId().toString() : "";
            } else {
