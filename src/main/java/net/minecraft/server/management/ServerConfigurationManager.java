...
public abstract class ServerConfigurationManager {
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
        ...
        String s = null == gameprofile1 ? gameprofile.getName() : gameprofile1.getName();
        ...
        if (null != netManager.getRemoteAddress()) {
        ...
        if (0 < mcServer.getResourcePackUrl().length()) {
        ...
        if (null != nbttagcompound && nbttagcompound.hasKey("Riding", 10)) {
    ...
    protected void sendScoreboard(ServerScoreboard scoreboardIn, EntityPlayerMP playerIn) {
        ...
        for (int i = 0; 19 > i; ++i) {
            ...
            if (null != scoreobjective && !set.contains(scoreobjective)) {
    ...
    public NBTTagCompound readPlayerDataFromFile(EntityPlayerMP playerIn) {
        ...
        if (playerIn.getName().equals(this.mcServer.getServerOwner()) && null != nbttagcompound) {
    ...
    public String allowUserToConnect(SocketAddress address, GameProfile profile) {
        if (this.bannedPlayers.isBanned(profile)) {
            ...
            if (null != userlistbansentry.getBanEndDate()) {
            ...
            if (null != ipbanentry.getBanEndDate()) {
    ...
    public EntityPlayerMP createPlayerForUser(GameProfile profile) {
        ...
        if (null != entityplayermp2 && !list.contains(entityplayermp2)) {
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd) {
        ...
        while (!worldserver.getCollidingBoundingBoxes(entityplayermp, entityplayermp.getEntityBoundingBox()).isEmpty() && 256.0D > entityplayermp.posY) {
    ...
    public void sendMessageToAllTeamMembers(EntityPlayer player, IChatComponent message) {
        ...
        if (null != team) {
            for (String s : team.getMembershipCollection()) {
                ...
                if (null != entityplayermp && entityplayermp != player) {
    ...
    public StatisticsFile getPlayerStatsFile(EntityPlayer playerIn) {
        UUID uuid = playerIn.getUniqueID();
        StatisticsFile statisticsfile = null == uuid ? null : this.playerStatFiles.get(uuid);
