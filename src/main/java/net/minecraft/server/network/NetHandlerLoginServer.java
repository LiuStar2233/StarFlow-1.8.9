...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
     ...
     */
    public void update() {
        if (LoginState.READY_TO_ACCEPT == currentLoginState) {
            this.tryAcceptPlayer();
        } else if (LoginState.DELAY_ACCEPT == currentLoginState) {
    ...
    public void tryAcceptPlayer() {
        ...
        if (null != s) {
            ...
            if (0 <= server.getNetworkCompressionTreshold() && !this.networkManager.isLocalChannel()) {
    ...
    public String getConnectionInfo() {
        return null != loginGameProfile ? this.loginGameProfile + " (" + this.networkManager.getRemoteAddress().toString() + ")" : String.valueOf(this.networkManager.getRemoteAddress());
    }

    public void processLoginStart(C00PacketLoginStart packetIn) {
        Validate.validState(LoginState.HELLO == currentLoginState, "Unexpected hello packet");
    ...
    public void processEncryptionResponse(C01PacketEncryptionResponse packetIn) {
        Validate.validState(LoginState.KEY == currentLoginState, "Unexpected key packet");
