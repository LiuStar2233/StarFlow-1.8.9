...
public class Achievement extends StatBase {
    ...
    public String getDescription() {
        return null != statStringFormatter ? this.statStringFormatter.formatString(StatCollector.translateToLocal(this.achievementDescription)) : StatCollector.translateToLocal(this.achievementDescription);
    }
