...
public class StatBase {
    ...
    public static IStatType timeStatType = new IStatType() {
        public String format(int number) {
            ...
            double d3 = d2 / 24.0D;
            double d4 = d3 / 365.0D;
            return 0.5D < d4 ? StatBase.decimalFormat.format(d4) + " y" : (0.5D < d3 ? StatBase.decimalFormat.format(d3) + " d" : (0.5D < d2 ? StatBase.decimalFormat.format(d2) + " h" : (0.5D < d1 ? StatBase.decimalFormat.format(d1) + " m" : d0 + " s")));
        }
    };
    public static IStatType distanceStatType = new IStatType() {
        public String format(int number) {
            ...
            return 0.5D < d1 ? StatBase.decimalFormat.format(d1) + " km" : (0.5D < d0 ? StatBase.decimalFormat.format(d0) + " m" : number + " cm");
        }
    };
