...
public class StatList {
    ...
    private static void initCraftableStats() {
        ...
        for (IRecipe irecipe : CraftingManager.getInstance().getRecipeList()) {
            if (null != irecipe.getRecipeOutput()) {
    ...
    private static void initMiningStats() {
        for (Block block : Block.blockRegistry) {
            ...
            if (null != item) {
                ...
                if (null != s && block.getEnableStats()) {
    ...
    private static String func_180204_a(Item p_180204_0_) {
        ...
        return null != resourcelocation ? resourcelocation.toString().replace(':', '.') : null;
    }
    ...
    private static void mergeStatBases(StatBase[] statBaseIn, Block p_151180_1_, Block p_151180_2_) {
        ...
        if (null != statBaseIn[i] && null == statBaseIn[j]) {
    ...
    public static StatBase getStatKillEntity(EntityList.EntityEggInfo eggInfo) {
        ...
        return null == s ? null : (new StatBase("stat.killEntity." + s, new ChatComponentTranslation("stat.entityKill", new ChatComponentTranslation("entity." + s + ".name")))).registerStat();
    }

    public static StatBase getStatEntityKilledBy(EntityList.EntityEggInfo eggInfo) {
        String s = EntityList.getStringFromID(eggInfo.spawnedID);
        return null == s ? null : (new StatBase("stat.entityKilledBy." + s, new ChatComponentTranslation("stat.entityKilledBy", new ChatComponentTranslation("entity." + s + ".name")))).registerStat();
    }
