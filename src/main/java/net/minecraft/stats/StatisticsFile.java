...
public class StatisticsFile extends StatFileWriter {
    ...
    public void unlockAchievement(EntityPlayer playerIn, StatBase statIn, int p_150873_3_) {
        ...
        if (statIn.isAchievement() && 0 == i && 0 < p_150873_3_) {
            ...
            for (final Map.Entry<String, JsonElement> entry : jsonobject.entrySet()) {
                ...
                if (null != statbase) {
                    ...
                    if (entry.getValue().isJsonPrimitive() && entry.getValue().getAsJsonPrimitive().isNumber()) {
                        ...
                        if (jsonobject1.has("progress") && null != statbase.func_150954_l()) {
                            try {
                                final Constructor<? extends IJsonSerializable> constructor = statbase.func_150954_l().getConstructor();
                                final IJsonSerializable ijsonserializable = constructor.newInstance();
    ...
    public static String dumpJson(final Map<StatBase, TupleIntJsonSerializable> p_150880_0_) {
        ...
        for (Map.Entry<StatBase, TupleIntJsonSerializable> entry : p_150880_0_.entrySet()) {
            if (null != entry.getValue().getJsonSerializableValue()) {
    ...
    public void func_150876_a(EntityPlayerMP p_150876_1_) {
        ...
        if (this.field_150886_g || 300 < i - field_150885_f) {
