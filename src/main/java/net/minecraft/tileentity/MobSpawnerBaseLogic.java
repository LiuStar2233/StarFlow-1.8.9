...
public abstract class MobSpawnerBaseLogic {
        ...
        if (this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    ...
                    if (null == entityliving || entityliving.getCanSpawnHere() && entityliving.isNotColliding()) {
    ...
    private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
        if (null != getRandomEntity()) {
            ...
            if (null != entityIn.worldObj && spawn) {
        ...
        } else if (entityIn instanceof EntityLivingBase && null != entityIn.worldObj && spawn) {
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        if (!StringUtils.isNullOrEmpty(s)) {
            ...
            if (null != getRandomEntity() || 0 < minecartToSpawn.size()) {
    ...
    public boolean setDelayToMin(int delay) {
        if (1 == delay && this.getSpawnerWorld().isRemote) {
            this.spawnDelay = this.minSpawnDelay;
            return true;
        } else {
            return false;
