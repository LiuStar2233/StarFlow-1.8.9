...
public class TileEntityBanner extends TileEntity {
    ...
    public static int getBaseColor(ItemStack stack) {
        ...
        return null != nbttagcompound && nbttagcompound.hasKey("Base") ? nbttagcompound.getInteger("Base") : stack.getMetadata();
    }
    ...
    public static int getPatterns(ItemStack stack) {
        NBTTagCompound nbttagcompound = stack.getSubCompound("BlockEntityTag", false);
        return null != nbttagcompound && nbttagcompound.hasKey("Patterns") ? nbttagcompound.getTagList("Patterns", 10).tagCount() : 0;
    }
    ...
    private void initializeBannerData() {
        if (null == patternList || null == colorList || null == patternResourceLocation) {
    ...
    public static void removeBannerData(ItemStack stack) {
        ...
        if (null != nbttagcompound && nbttagcompound.hasKey("Patterns", 9)) {
    ...
    public enum EnumBannerPattern {
        ...
        public boolean hasValidCrafting() {
            return null != patternCraftingStack || null != craftingLayers[0];
        }

        public boolean hasCraftingStack() {
            return null != patternCraftingStack;
        }
