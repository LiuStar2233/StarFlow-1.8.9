...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public boolean hasCustomName() {
        return null != customName && 0 < customName.length();
    }
    ...
    private boolean canBrew() {
        if (null != brewingItemStacks[3] && 0 < brewingItemStacks[3].stackSize) {
            ...
            if (!itemstack.getItem().isPotionIngredient(itemstack)) {
                ...
                for (int i = 0; 3 > i; ++i) {
                    if (null != brewingItemStacks[i] && this.brewingItemStacks[i].getItem() == Items.potionitem) {
                        ...
                        if ((0 >= j || list != list1) && (null == list || !list.equals(list1) && null != list1) && j != k) {
                            flag = true;
                            break;
                        }
                    }
        ...
        if (this.canBrew()) {
            ...
            for (int i = 0; 3 > i; ++i) {
                if (null != brewingItemStacks[i] && this.brewingItemStacks[i].getItem() == Items.potionitem) {
                    ...
                    if (0 < j && list == list1 || null != list && (list.equals(list1) || null == list1)) {
                        if (!ItemPotion.isSplash(j) && ItemPotion.isSplash(k)) {
            ...
            if (itemstack.getItem().hasContainerItem()) {
                ...
                if (0 >= brewingItemStacks[3].stackSize) {
    ...
    private int getPotionResult(int meta, ItemStack stack) {
        return null == stack ? meta : (stack.getItem().isPotionIngredient(stack) ? PotionHelper.applyIngredient(meta, stack.getItem().getPotionEffect(stack)) : meta);
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
            ...
            if (0 <= j && j < this.brewingItemStacks.length) {
    ...
    public ItemStack getStackInSlot(int index) {
        return 0 <= index && index < this.brewingItemStacks.length ? this.brewingItemStacks[index] : null;
    }
    ...
    public ItemStack decrStackSize(int index, int count) {
        if (0 <= index && index < this.brewingItemStacks.length) {
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        return 3 == index ? stack.getItem().isPotionIngredient(stack) : stack.getItem() == Items.potionitem || stack.getItem() == Items.glass_bottle;
    }
    ...
    public int[] getSlotsForFace(EnumFacing side) {
        return EnumFacing.UP == side ? inputSlots : outputSlots;
    }
