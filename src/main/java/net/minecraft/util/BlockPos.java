...
public class BlockPos extends Vec3i {
    ...
    public BlockPos add(double x, double y, double z) {
        return 0.0D == x && 0.0D == y && 0.0D == z ? this : new BlockPos((double) this.getX() + x, (double) this.getY() + y, (double) this.getZ() + z);
    }
    ...
    public BlockPos add(int x, int y, int z) {
        return 0 == x && 0 == y && 0 == z ? this : new BlockPos(this.getX() + x, this.getY() + y, this.getZ() + z);
    }
    ...
    public BlockPos add(Vec3i vec) {
        return 0 == vec.getX() && 0 == vec.getY() && 0 == vec.getZ() ? this : new BlockPos(this.getX() + vec.getX(), this.getY() + vec.getY(), this.getZ() + vec.getZ());
    }
    ...
    public BlockPos offset(EnumFacing facing, int n) {
        return 0 == n ? this : new BlockPos(this.getX() + facing.getFrontOffsetX() * n, this.getY() + facing.getFrontOffsetY() * n, this.getZ() + facing.getFrontOffsetZ() * n);
    }
