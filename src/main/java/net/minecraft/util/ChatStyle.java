...
public class ChatStyle {
     ...
     */
    public EnumChatFormatting getColor() {
        return null == color ? this.getParent().getColor() : this.color;
    }
     ...
     */
    public boolean getBold() {
        return null == bold ? this.getParent().getBold() : this.bold.booleanValue();
    }
     ...
     */
    public boolean getItalic() {
        return null == italic ? this.getParent().getItalic() : this.italic.booleanValue();
    }
     ...
     */
    public boolean getStrikethrough() {
        return null == strikethrough ? this.getParent().getStrikethrough() : this.strikethrough.booleanValue();
    }
     ...
     */
    public boolean getUnderlined() {
        return null == underlined ? this.getParent().getUnderlined() : this.underlined.booleanValue();
    }
     ...
     */
    public boolean getObfuscated() {
        return null == obfuscated ? this.getParent().getObfuscated() : this.obfuscated.booleanValue();
    }
    ...
    public boolean isEmpty() {
        return null == bold && null == italic && null == strikethrough && null == underlined && null == obfuscated && null == color && null == chatClickEvent && null == chatHoverEvent;
    }
     ...
     */
    public ClickEvent getChatClickEvent() {
        return null == chatClickEvent ? this.getParent().getChatClickEvent() : this.chatClickEvent;
    }
     ...
     */
    public HoverEvent getChatHoverEvent() {
        return null == chatHoverEvent ? this.getParent().getChatHoverEvent() : this.chatHoverEvent;
    }
     ...
     */
    public String getInsertion() {
        return null == insertion ? this.getParent().getInsertion() : this.insertion;
    }
    ...
    public String getFormattingCode() {
        if (this.isEmpty()) {
            return null != parentStyle ? this.parentStyle.getFormattingCode() : "";
        } else {
    ...
    private ChatStyle getParent() {
        return null == parentStyle ? rootStyle : this.parentStyle;
    }

    public String toString() {
        return "Style{hasParent=" + (null != parentStyle) + ", color=" + this.color + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", obfuscated=" + this.obfuscated + ", clickEvent=" + this.getChatClickEvent() + ", hoverEvent=" + this.getChatHoverEvent() + ", insertion=" + this.getInsertion() + '}';
    }
        ...
        if (this == p_equals_1_) {
            ...
            label0:
            {
                ...
                if (this.getBold() == chatstyle.getBold() && this.getColor() == chatstyle.getColor() && this.getItalic() == chatstyle.getItalic() && this.getObfuscated() == chatstyle.getObfuscated() && this.getStrikethrough() == chatstyle.getStrikethrough() && this.getUnderlined() == chatstyle.getUnderlined()) {
                    label85:
                    {
                        if (null != getChatClickEvent()) {
                            if (!this.getChatClickEvent().equals(chatstyle.getChatClickEvent())) {
                                break label85;
                            }
                        } else if (null != chatstyle.getChatClickEvent()) {
                            break label85;
                        }

                        if (null != getChatHoverEvent()) {
                            if (!this.getChatHoverEvent().equals(chatstyle.getChatHoverEvent())) {
                                break label85;
                            }
                        } else if (null != chatstyle.getChatHoverEvent()) {
                            break label85;
                        }

                        if (null != getInsertion()) {
                            if (this.getInsertion().equals(chatstyle.getInsertion())) {
                                break label0;
                            }
                        } else if (null == chatstyle.getInsertion()) {
                            break label0;
                        }
                    }
                }
    ...
    public static class Serializer implements JsonDeserializer<ChatStyle>, JsonSerializer<ChatStyle> {
                ...
                if (null == jsonobject) {
                    ...
                    if (jsonobject.has("clickEvent")) {
                        ...
                        if (null != jsonobject1) {
                            ...
                            ClickEvent.Action clickevent$action = null == jsonprimitive ? null : ClickEvent.Action.getValueByCanonicalName(jsonprimitive.getAsString());
                            JsonPrimitive jsonprimitive1 = jsonobject1.getAsJsonPrimitive("value");
                            String s = null == jsonprimitive1 ? null : jsonprimitive1.getAsString();

                            if (null != clickevent$action && null != s && clickevent$action.shouldAllowInChat()) {
                    ...
                    if (jsonobject.has("hoverEvent")) {
                        ...
                        if (null != jsonobject2) {
                            ...
                            HoverEvent.Action hoverevent$action = null == jsonprimitive2 ? null : HoverEvent.Action.getValueByCanonicalName(jsonprimitive2.getAsString());
                            IChatComponent ichatcomponent = p_deserialize_3_.deserialize(jsonobject2.get("value"), IChatComponent.class);

                            if (null != hoverevent$action && null != ichatcomponent && hoverevent$action.shouldAllowInChat()) {
        ...
        public JsonElement serialize(ChatStyle p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
            if (p_serialize_1_.isEmpty()) {
                ...
                if (null != p_serialize_1_.chatHoverEvent) {
