...
public class EntityDamageSource extends DamageSource {
    ...
    public boolean isDifficultyScaled() {
        return null != damageSourceEntity && this.damageSourceEntity instanceof EntityLivingBase && !(this.damageSourceEntity instanceof EntityPlayer);
    }
}