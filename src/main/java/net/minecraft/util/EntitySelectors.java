...
public final class EntitySelectors {
    ...
    public static final Predicate<Entity> IS_STANDALONE = new Predicate<Entity>() {
        public boolean apply(Entity p_apply_1_) {
            return p_apply_1_.isEntityAlive() && null == p_apply_1_.riddenByEntity && null == p_apply_1_.ridingEntity;
        }
    };
    ...
    public static class ArmoredMob implements Predicate<Entity> {
        ...
        public boolean apply(Entity p_apply_1_) {
            if (!p_apply_1_.isEntityAlive()) {
                ...
                return null == entitylivingbase.getEquipmentInSlot(EntityLiving.getArmorPosition(armor)) && (entitylivingbase instanceof EntityLiving ? ((EntityLiving) entitylivingbase).canPickUpLoot() : (entitylivingbase instanceof EntityArmorStand || entitylivingbase instanceof EntityPlayer));
            }
        }
    }
}