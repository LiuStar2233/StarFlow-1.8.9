...
public enum EnumChatFormatting {
    ...
    public boolean isColor() {
        return !this.fancyStyling && RESET != this;
    }
    ...
    public static String getTextWithoutFormattingCodes(String text) {
        return null == text ? null : formattingCodePattern.matcher(text).replaceAll("");
    }
    ...
    public static EnumChatFormatting getValueByName(String friendlyName) {
        return null == friendlyName ? null : nameMapping.get(func_175745_c(friendlyName));
    }
