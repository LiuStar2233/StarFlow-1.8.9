...
public enum EnumFacing implements IStringSerializable {
    ...
    public int getFrontOffsetX() {
        return Axis.X == axis ? this.axisDirection.getOffset() : 0;
    }

    public int getFrontOffsetY() {
        return Axis.Y == axis ? this.axisDirection.getOffset() : 0;
    }
    ...
    public int getFrontOffsetZ() {
        return Axis.Z == axis ? this.axisDirection.getOffset() : 0;
    }
    ...
    public static EnumFacing byName(String name) {
        return null == name ? null : NAME_LOOKUP.get(name.toLowerCase());
    }
    ...
    public enum Axis implements Predicate<EnumFacing>, IStringSerializable {
        ...
        public boolean isVertical() {
            return Plane.VERTICAL == plane;
        }

        public boolean isHorizontal() {
            return Plane.HORIZONTAL == plane;
        }
        ...
        public boolean apply(EnumFacing p_apply_1_) {
            return null != p_apply_1_ && p_apply_1_.getAxis() == this;
        }
    ...
    public enum Plane implements Predicate<EnumFacing>, Iterable<EnumFacing> {
        ...
        public boolean apply(EnumFacing p_apply_1_) {
            return null != p_apply_1_ && p_apply_1_.getAxis().getPlane() == this;
        }
