...
public class IntHashMap<V> {
    ...
    public V lookup(int p_76041_1_) {
        ...
        for (IntHashMap.Entry<V> entry = this.slots[getSlotIndex(i, this.slots.length)]; null != entry; entry = entry.nextEntry) {
    ...
    public boolean containsItem(int p_76037_1_) {
        return null != lookupEntry(p_76037_1_);
    }
    ...
    public void addKey(int p_76038_1_, V p_76038_2_) {
        ...
        for (IntHashMap.Entry<V> entry = this.slots[j]; null != entry; entry = entry.nextEntry) {
    ...
    public V removeObject(int p_76049_1_) {
        ...
        return null == entry ? null : entry.valueEntry;
    }
    ...
    final IntHashMap.Entry<V> removeEntry(int p_76036_1_) {
        ...
        for (entry1 = entry; null != entry1; entry1 = entry2) {
