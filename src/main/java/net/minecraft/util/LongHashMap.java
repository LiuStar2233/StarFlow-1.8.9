...
public class LongHashMap<V> {
    ...
    public V getValueByKey(long p_76164_1_) {
        ...
        for (LongHashMap.Entry<V> entry = this.hashArray[getHashIndex(i, this.mask)]; null != entry; entry = entry.nextEntry) {
    ...
    public boolean containsItem(long p_76161_1_) {
        return null != getEntry(p_76161_1_);
    }
    ...
    public void add(long p_76163_1_, V p_76163_3_) {
        ...
        for (LongHashMap.Entry<V> entry = this.hashArray[j]; null != entry; entry = entry.nextEntry) {
