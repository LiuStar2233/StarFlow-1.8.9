...
public class MathHelper {
    ...
    public static int func_154353_e(double value) {
        return (int) (0.0D <= value ? value : -value + 1.0D);
    }
    ...
    public static double denormalizeClamp(double lowerBnd, double upperBnd, double slide) {
        return 0.0D > slide ? lowerBnd : (1.0D < slide ? upperBnd : lowerBnd + (upperBnd - lowerBnd) * slide);
    }
    ...
    public static int bucketInt(int p_76137_0_, int p_76137_1_) {
        return 0 > p_76137_0_ ? -((-p_76137_0_ - 1) / p_76137_1_) - 1 : p_76137_0_ / p_76137_1_;
    }
    ...
    public static boolean epsilonEquals(float p_180185_0_, float p_180185_1_) {
        return 1.0E-5F > MathHelper.abs(p_180185_1_ - p_180185_0_);
    }
    ...
    public static int roundUp(int p_154354_0_, int p_154354_1_) {
        if (0 == p_154354_1_) {
            ...
            return 0 == i ? p_154354_0_ : p_154354_0_ + p_154354_1_ - i;
        }
    }
    ...
    public static double atan2(double p_181159_0_, double p_181159_2_) {
        ...
        if (Double.isNaN(d0)) {
            ...
            boolean flag = 0.0D > p_181159_0_;

            if (flag) {
                p_181159_0_ = -p_181159_0_;
            }

            boolean flag1 = 0.0D > p_181159_2_;
