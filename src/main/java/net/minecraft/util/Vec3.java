...
public class Vec3 {
    ...
    public Vec3 normalize() {
        ...
        return 1.0E-4D > d0 ? new Vec3(0.0D, 0.0D, 0.0D) : new Vec3(this.xCoord / d0, this.yCoord / d0, this.zCoord / d0);
    }
    ...
    public Vec3 getIntermediateWithXValue(Vec3 vec, double x) {
        ...
        if (1.0000000116860974E-7D > d0 * d0) {
            return null;
        } else {
            double d3 = (x - this.xCoord) / d0;
            return 0.0D <= d3 && 1.0D >= d3 ? new Vec3(this.xCoord + d0 * d3, this.yCoord + d1 * d3, this.zCoord + d2 * d3) : null;
        }
    }
    ...
    public Vec3 getIntermediateWithYValue(Vec3 vec, double y) {
        ...
        if (1.0000000116860974E-7D > d1 * d1) {
            return null;
        } else {
    ...
    public Vec3 getIntermediateWithZValue(Vec3 vec, double z) {
        ...
        if (1.0000000116860974E-7D > d2 * d2) {
            return null;
        } else {
