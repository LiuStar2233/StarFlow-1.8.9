...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
    ...
    public void writeToBuf(PacketBuffer buffer) {
        ...
        for (int i = 0; i < this.size(); ++i) {
            ...
            buffer.writeBoolean(null != itemstack);
