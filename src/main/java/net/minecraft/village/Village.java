...
public class Village {
    ...
    public void tick(int p_75560_1_) {
        ...
        if (this.numIronGolems < i && 20 < villageDoorInfoList.size() && 0 == worldObj.rand.nextInt(7000)) {
    ...
    public VillageDoorInfo getExistedDoor(BlockPos doorBlock) {
        if (this.center.distanceSq(doorBlock) > (double) (this.villageRadius * this.villageRadius)) {
            ...
            for (VillageDoorInfo villagedoorinfo : this.villageDoorInfoList) {
                if (villagedoorinfo.getDoorBlockPos().getX() == doorBlock.getX() && villagedoorinfo.getDoorBlockPos().getZ() == doorBlock.getZ() && 1 >= Math.abs(villagedoorinfo.getDoorBlockPos().getY() - doorBlock.getY())) {
                    return villagedoorinfo;
                }
            }
    ...
    public EntityLivingBase findNearestVillageAggressor(EntityLivingBase entitylivingbaseIn) {
        ...
        return null != village$villageaggressor ? village$villageaggressor.agressor : null;
    }
    ...
    private void removeDeadAndOldAgressors() {
        ...
        while (iterator.hasNext()) {
            ...
            if (!village$villageaggressor.agressor.isEntityAlive() || 300 < Math.abs(tickCounter - village$villageaggressor.agressionTime)) {
                iterator.remove();
            }
        }
    }
    ...
    private void removeDeadAndOutOfRangeDoors() {
        boolean flag = false;
        boolean flag1 = 0 == worldObj.rand.nextInt(50);
        ...
        while (iterator.hasNext()) {
            ...
            if (!this.isWoodDoor(villagedoorinfo.getDoorBlockPos()) || 1200 < Math.abs(tickCounter - villagedoorinfo.getInsidePosY())) {
    ...
    public boolean isPlayerReputationTooLow(String p_82687_1_) {
        return -15 >= getReputationForPlayer(p_82687_1_);
    }
    ...
    public boolean isMatingSeason() {
        return 0 == noBreedTicks || 3600 <= tickCounter - noBreedTicks;
    }
