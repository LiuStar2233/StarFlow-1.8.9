...
public class VillageDoorInfo {
    ...
    private static EnumFacing getFaceDirection(int deltaX, int deltaZ) {
        return 0 > deltaX ? EnumFacing.WEST : (0 < deltaX ? EnumFacing.EAST : (0 > deltaZ ? EnumFacing.NORTH : EnumFacing.SOUTH));
    }
    ...
    public boolean func_179850_c(BlockPos pos) {
        ...
        return 0 <= i * insideDirection.getFrontOffsetX() + j * insideDirection.getFrontOffsetZ();
    }
