...
public class VillageSiege {
    ...
    public void tick() {
        ...
        } else if (2 != field_75536_c) {
            if (0 == field_75536_c) {
                float f = this.worldObj.getCelestialAngle(0.0F);

                if (0.5D > (double) f || 0.501D < (double) f) {
                    return;
                }

                this.field_75536_c = 0 == worldObj.rand.nextInt(10) ? 1 : 2;
    ...
    private boolean func_75529_b() {
        ...
        while (true) {
            ...
            if (!entityplayer.isSpectator()) {
                ...
                if (null != theVillage && 10 <= theVillage.getNumVillageDoors() && 20 <= theVillage.getTicksSinceLastDoorAdding() && 20 <= theVillage.getNumVillagers()) {
