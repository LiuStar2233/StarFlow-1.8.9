...
public class GameRules {
    ...
    public String getString(String name) {
        ...
        return null != gamerules$value ? gamerules$value.getString() : "";
    }
    ...
    public boolean getBoolean(String name) {
        GameRules.Value gamerules$value = this.theGameRules.get(name);
        return null != gamerules$value && gamerules$value.getBoolean();
    }

    public int getInt(String name) {
        GameRules.Value gamerules$value = this.theGameRules.get(name);
        return null != gamerules$value ? gamerules$value.getInt() : 0;
    }
    ...
    public boolean areSameType(String key, GameRules.ValueType otherValue) {
        GameRules.Value gamerules$value = this.theGameRules.get(key);
        return null != gamerules$value && (gamerules$value.getType() == otherValue || ValueType.ANY_VALUE == otherValue);
    }
