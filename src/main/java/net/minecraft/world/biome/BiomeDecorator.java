...
public class BiomeDecorator {
    ...
    protected void genDecorations(BiomeGenBase biomeGenBaseIn) {
        ...
        if (0 == randomGenerator.nextInt(10)) {
            ++k1;
        }
        ...
        for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
            ...
            if (0 < i15) {
                ...
                for (blockpos4 = this.field_180294_c.add(l7, j18, k11); 0 < blockpos4.getY(); blockpos4 = blockpos7) {
        ...
        for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
            if (0 == randomGenerator.nextInt(4)) {
        ...
        if (0 == randomGenerator.nextInt(32)) {
