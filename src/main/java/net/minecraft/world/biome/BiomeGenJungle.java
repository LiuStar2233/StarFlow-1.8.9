...
public class BiomeGenJungle extends BiomeGenBase {
    ...
    public WorldGenAbstractTree genBigTreeChance(Random rand) {
        return 0 == rand.nextInt(10) ? this.worldGeneratorBigTree : (0 == rand.nextInt(2) ? new WorldGenShrub(field_181620_aE, field_181622_aG) : (!this.field_150614_aC && 0 == rand.nextInt(3) ? new WorldGenMegaJungle(false, 10, 20, field_181620_aE, field_181621_aF) : new WorldGenTrees(false, 4 + rand.nextInt(7), field_181620_aE, field_181621_aF, true)));
    }
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random rand) {
        return 0 == rand.nextInt(4) ? new WorldGenTallGrass(BlockTallGrass.EnumType.FERN) : new WorldGenTallGrass(BlockTallGrass.EnumType.GRASS);
    }
