...
public class BiomeGenMesa extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal) {
        if (null == field_150621_aC || this.field_150622_aD != worldIn.getSeed()) {
            this.func_150619_a(worldIn.getSeed());
        }

        if (null == field_150623_aE || null == field_150624_aF || this.field_150622_aD != worldIn.getSeed()) {
        ...
        boolean flag = 0.0D < Math.cos(noiseVal / 3.0D * Math.PI);
        int l = -1;
        boolean flag1 = false;

        for (int i1 = 255; 0 <= i1; --i1) {
            ...
            if (i1 <= rand.nextInt(5)) {
                ...
                if (iblockstate1.getBlock().getMaterial() == Material.air) {
                    ...
                    if (-1 == l) {
                        ...
                        if (i1 < l1 && (null == iblockstate || iblockstate.getBlock().getMaterial() == Material.air)) {
    ...
    private void func_150619_a(long p_150619_1_) {
        ...
        for (int k2 = 0; k2 < j2; ++k2) {
            ...
            for (int i1 = 0; 64 > l3 + i1 && i1 < i3; ++i1) {
        ...
        for (int j3 = 0; j3 < l2; ++j3) {
            ...
            for (int j1 = 0; 64 > k4 + j1 && j1 < i4; ++j1) {
        ...
        for (int l4 = 0; l4 < k3; ++l4) {
            ...
            for (int k1 = 0; 64 > j4 + k1 && i5 > k1; ++k1) {
                ...
                if (63 > j4 + k1 && random.nextBoolean()) {
                    this.field_150621_aC[j4 + k1 + 1] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
                }
            }
        }
