...
public class BiomeGenPlains extends BiomeGenBase {
    ...
    public BlockFlower.EnumFlowerType pickRandomFlower(Random rand, BlockPos pos) {
        ...
        } else if (0 < rand.nextInt(3)) {
            int i = rand.nextInt(3);
            return 0 == i ? BlockFlower.EnumFlowerType.POPPY : (1 == i ? BlockFlower.EnumFlowerType.HOUSTONIA : BlockFlower.EnumFlowerType.OXEYE_DAISY);
        } else {
