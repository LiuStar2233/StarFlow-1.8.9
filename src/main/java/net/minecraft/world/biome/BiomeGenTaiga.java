...
public class BiomeGenTaiga extends BiomeGenBase {
    ...
    public BiomeGenTaiga(int id, int p_i45385_2_) {
        ...
        if (1 != p_i45385_2_ && 2 != p_i45385_2_) {
    ...
    public WorldGenAbstractTree genBigTreeChance(Random rand) {
        return (1 == field_150644_aH || 2 == field_150644_aH) && 0 == rand.nextInt(3) ? (2 != field_150644_aH && 0 != rand.nextInt(13) ? field_150641_aE : field_150642_aF) : (0 == rand.nextInt(3) ? field_150639_aC : field_150640_aD);
    }
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random rand) {
        return 0 < rand.nextInt(5) ? new WorldGenTallGrass(BlockTallGrass.EnumType.FERN) : new WorldGenTallGrass(BlockTallGrass.EnumType.GRASS);
    }

    public void decorate(World worldIn, Random rand, BlockPos pos) {
        if (1 == field_150644_aH || 2 == field_150644_aH) {
