...
public class WorldChunkManager {
    ...
    public float[] getRainfall(float[] listToReuse, int x, int z, int width, int length) {
        ...
        if (null == listToReuse || listToReuse.length < width * length) {
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] biomes, int x, int z, int width, int height) {
        ...
        if (null == biomes || biomes.length < width * height) {
    ...
    public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] listToReuse, int x, int z, int width, int length, boolean cacheFlag) {
        ...
        if (cacheFlag && 16 == width && 16 == length && 0 == (x & 15) && 0 == (z & 15)) {
    ...
    public BlockPos findBiomePosition(int x, int z, int range, List<BiomeGenBase> biomes, Random random) {
        ...
        for (int l1 = 0; l1 < i1 * j1; ++l1) {
            ...
            if (biomes.contains(biomegenbase) && (null == blockpos || 0 == random.nextInt(k1 + 1))) {
