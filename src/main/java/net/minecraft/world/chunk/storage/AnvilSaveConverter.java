...
public class AnvilSaveConverter extends SaveFormatOld {
    ...
    public List<SaveFormatComparator> getSaveList() throws AnvilConverterException {
        if (null != savesDirectory && this.savesDirectory.exists() && this.savesDirectory.isDirectory()) {
            ...
            for (File file1 : afile) {
                if (file1.isDirectory()) {
                    ...
                    if (null != worldinfo && (19132 == worldinfo.getSaveVersion() || 19133 == worldinfo.getSaveVersion())) {
    ...
    public boolean isConvertible(String saveName) {
        ...
        return null != worldinfo && 19132 == worldinfo.getSaveVersion();
    }
    ...
    public boolean isOldMapFormat(String saveName) {
        WorldInfo worldinfo = this.getWorldInfo(saveName);
        return null != worldinfo && worldinfo.getSaveVersion() != this.getSaveVersion();
    }
