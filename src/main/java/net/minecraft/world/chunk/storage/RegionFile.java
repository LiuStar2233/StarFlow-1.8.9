...
public class RegionFile {
    ...
    public RegionFile(File fileNameIn) {
        ...
        try {
            ...
            if (4096L > dataFile.length()) {
                for (int i = 0; 1024 > i; ++i) {
                    this.dataFile.writeInt(0);
                }

                for (int i1 = 0; 1024 > i1; ++i1) {
                    this.dataFile.writeInt(0);
                }
            ...
            for (int l1 = 0; 1024 > l1; ++l1) {
                int k = this.dataFile.readInt();
                this.offsets[l1] = k;

                if (0 != k && (k >> 8) + (k & 255) <= this.sectorFree.size()) {
    ...
    private void setOffset(int x, int z, int offset) throws IOException {
        ...
        this.dataFile.seek((long) ((x + z * 32L) * 4));
    ...
    private void setChunkTimestamp(int x, int z, int timestamp) throws IOException {
        ...
        this.dataFile.seek((long) (4096 + (x + z * 32L) * 4));
