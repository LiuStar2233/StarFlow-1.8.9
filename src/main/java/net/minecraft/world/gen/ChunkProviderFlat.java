...
public class ChunkProviderFlat implements IChunkProvider {
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z) {
        ...
        if (null != waterLakeGenerator && !flag && 0 == random.nextInt(4)) {
        ...
        if (null != lavaLakeGenerator && !flag && 0 == random.nextInt(8)) {
            ...
            if (blockpos1.getY() < this.worldObj.getSeaLevel() || 0 == random.nextInt(10)) {
