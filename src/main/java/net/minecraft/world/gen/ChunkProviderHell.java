...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public void func_180516_b(int p_180516_1_, int p_180516_2_, ChunkPrimer p_180516_3_) {
        ...
        for (int j = 0; 16 > j; ++j) {
            for (int k = 0; 16 > k; ++k) {
                boolean flag = 0.0D < slowsandNoise[j + k * 16] + hellRNG.nextDouble() * 0.2D;
                boolean flag1 = 0.0D < gravelNoise[j + k * 16] + hellRNG.nextDouble() * 0.2D;
