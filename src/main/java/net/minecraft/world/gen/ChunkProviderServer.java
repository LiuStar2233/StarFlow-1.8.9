...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        return null == chunk ? (!this.worldObj.isFindingSpawnPoint() && !this.chunkLoadOverride ? this.dummyChunk : this.loadChunk(x, z)) : chunk;
    }
    ...
    public boolean populateChunk(IChunkProvider chunkProvider, Chunk chunkIn, int x, int z) {
        if (null != serverChunkGenerator && this.serverChunkGenerator.populateChunk(chunkProvider, chunkIn, x, z)) {
            Chunk chunk = this.provideChunk(x, z);
            chunk.setChunkModified();
            return true;
        } else {
