...
public class ChunkProviderSettings {
    ...
    public static class Factory {
        ...
        public int hashCode() {
            int i = 0.0F != coordinateScale ? Float.floatToIntBits(this.coordinateScale) : 0;
            i = 31 * i + (0.0F != heightScale ? Float.floatToIntBits(this.heightScale) : 0);
            i = 31 * i + (0.0F != upperLimitScale ? Float.floatToIntBits(this.upperLimitScale) : 0);
            i = 31 * i + (0.0F != lowerLimitScale ? Float.floatToIntBits(this.lowerLimitScale) : 0);
            i = 31 * i + (0.0F != depthNoiseScaleX ? Float.floatToIntBits(this.depthNoiseScaleX) : 0);
            i = 31 * i + (0.0F != depthNoiseScaleZ ? Float.floatToIntBits(this.depthNoiseScaleZ) : 0);
            i = 31 * i + (0.0F != depthNoiseScaleExponent ? Float.floatToIntBits(this.depthNoiseScaleExponent) : 0);
            i = 31 * i + (0.0F != mainNoiseScaleX ? Float.floatToIntBits(this.mainNoiseScaleX) : 0);
            i = 31 * i + (0.0F != mainNoiseScaleY ? Float.floatToIntBits(this.mainNoiseScaleY) : 0);
            i = 31 * i + (0.0F != mainNoiseScaleZ ? Float.floatToIntBits(this.mainNoiseScaleZ) : 0);
            i = 31 * i + (0.0F != baseSize ? Float.floatToIntBits(this.baseSize) : 0);
            i = 31 * i + (0.0F != stretchY ? Float.floatToIntBits(this.stretchY) : 0);
            i = 31 * i + (0.0F != biomeDepthWeight ? Float.floatToIntBits(this.biomeDepthWeight) : 0);
            i = 31 * i + (0.0F != biomeDepthOffset ? Float.floatToIntBits(this.biomeDepthOffset) : 0);
            i = 31 * i + (0.0F != biomeScaleWeight ? Float.floatToIntBits(this.biomeScaleWeight) : 0);
            i = 31 * i + (0.0F != biomeScaleOffset ? Float.floatToIntBits(this.biomeScaleOffset) : 0);
    ...
    public static class Serializer implements JsonDeserializer<ChunkProviderSettings.Factory>, JsonSerializer<ChunkProviderSettings.Factory> {
        public ChunkProviderSettings.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            try {
                ...
                if (38 > chunkprovidersettings$factory.fixedBiome && -1 <= chunkprovidersettings$factory.fixedBiome) {
