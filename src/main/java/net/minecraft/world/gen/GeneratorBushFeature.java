...
public class GeneratorBushFeature extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        for (int i = 0; 64 > i; ++i) {
            ...
            if (worldIn.isAirBlock(blockpos) && (!worldIn.provider.getHasNoSky() || 255 > blockpos.getY()) && this.field_175908_a.canBlockStay(worldIn, blockpos, this.field_175908_a.getDefaultState())) {
