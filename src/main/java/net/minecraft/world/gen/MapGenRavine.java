                    ...
                    if (!flag2) {
                        ...
                        for (int j3 = k2; j3 < k; ++j3) {
                            ...
                            for (int i2 = i3; i2 < i1; ++i2) {
                                ...
                                if (1.0D > d10 * d10 + d7 * d7) {
                                    for (int j2 = l; j2 > l2; --j2) {
                                        double d8 = ((double) (j2 - 1) + 0.5D - p_180707_8_) / d2;

                                        if (1.0D > (d10 * d10 + d7 * d7) * (double) field_75046_d[j2 - 1] + d8 * d8 / 6.0D) {
