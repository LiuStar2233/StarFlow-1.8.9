                    ...
                    for (int l2 = k2; l2 <= position.getY() + i; ++l2) {
                        ...
                        for (int l1 = k3; l1 <= l3; ++l1) {
                            for (int i2 = j1; i2 <= k1; ++i2) {
                                ...
                                if (BlockHugeMushroom.EnumType.CENTER == blockhugemushroom$enumtype && l2 < position.getY() + i) {
                                    blockhugemushroom$enumtype = BlockHugeMushroom.EnumType.ALL_INSIDE;
                                }

                                if (position.getY() >= position.getY() + i - 1 || BlockHugeMushroom.EnumType.ALL_INSIDE != blockhugemushroom$enumtype) {
