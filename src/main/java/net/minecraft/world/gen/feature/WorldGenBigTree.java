...
public class WorldGenBigTree extends WorldGenAbstractTree {
        ...
        for (; 0 <= k; --k) {
            ...
            if (0.0F <= f) {
                for (int l = 0; l < i; ++l) {
                    ...
                    if (-1 == checkBlockLine(blockpos, blockpos1)) {
                        ...
                        if (-1 == checkBlockLine(blockpos2, blockpos)) {
    ...
    float leafSize(int p_76495_1_) {
        return 0 <= p_76495_1_ && p_76495_1_ < this.leafDistanceLimit ? (0 != p_76495_1_ && p_76495_1_ != this.leafDistanceLimit - 1 ? 3.0F : 2.0F) : -1.0F;
    }
