    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (1 <= k && 256 > k + i + 1) {
            ...
            if (block != Blocks.grass && block != Blocks.dirt) {
                ...
                for (int i3 = -2; 0 >= i3; ++i3) {
                    for (int l3 = -2; 0 >= l3; ++l3) {
                        int k4 = -1;
                ...
                for (int j3 = -3; 4 >= j3; ++j3) {
                    for (int i4 = -3; 4 >= i4; ++i4) {
                        if ((-3 != j3 || -3 != i4) && (-3 != j3 || 4 != i4) && (4 != j3 || -3 != i4) && (4 != j3 || 4 != i4) && (3 > Math.abs(j3) || 3 > Math.abs(i4))) {
                            this.func_150526_a(worldIn, k1 + j3, i2, l1 + i4);
                        }
                    }
                }

                for (int k3 = -1; 2 >= k3; ++k3) {
                    for (int j4 = -1; 2 >= j4; ++j4) {
                        if ((0 > k3 || 1 < k3 || 0 > j4 || 1 < j4) && 0 >= rand.nextInt(3)) {
                            ...
                            for (int j5 = -1; 1 >= j5; ++j5) {
                                for (int l2 = -1; 1 >= l2; ++l2) {
                                    this.func_150526_a(worldIn, k1 + k3 + j5, i2, l1 + j4 + l2);
                                }
                            }

                            for (int k5 = -2; 2 >= k5; ++k5) {
                                for (int l5 = -2; 2 >= l5; ++l5) {
                                    if (2 != Math.abs(k5) || 2 != Math.abs(l5)) {
