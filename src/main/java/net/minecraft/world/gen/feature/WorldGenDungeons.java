        ...
        for (int k2 = k; k2 <= l; ++k2) {
            for (int l2 = -1; 4 >= l2; ++l2) {
                for (int i3 = l1; i3 <= i2; ++i3) {
                    ...
                    if ((k2 == k || k2 == l || i3 == l1 || i3 == i2) && 0 == l2 && worldIn.isAirBlock(blockpos) && worldIn.isAirBlock(blockpos.up())) {
                        ++j2;
                    }
                }
            }
            ...
            for (int k3 = k; k3 <= l; ++k3) {
                for (int i4 = 3; -1 <= i4; --i4) {
                    for (int k4 = l1; k4 <= i2; ++k4) {
                        ...
                        if (k3 != k && -1 != i4 && k4 != l1 && k3 != l && 4 != i4 && k4 != i2) {
                            if (worldIn.getBlockState(blockpos1).getBlock() != Blocks.chest) {
                                worldIn.setBlockToAir(blockpos1);
                            }
                        } else if (0 <= blockpos1.getY() && !worldIn.getBlockState(blockpos1.down()).getBlock().getMaterial().isSolid()) {
                            worldIn.setBlockToAir(blockpos1);
