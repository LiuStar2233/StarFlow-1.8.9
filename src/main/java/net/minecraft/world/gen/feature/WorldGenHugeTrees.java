...
public abstract class WorldGenHugeTrees extends WorldGenAbstractTree {
    ...
    private boolean func_175926_c(World worldIn, BlockPos p_175926_2_, int p_175926_3_) {
        ...
        if (1 <= p_175926_2_.getY() && 256 >= p_175926_2_.getY() + p_175926_3_ + 1) {
            for (int i = 0; i <= 1 + p_175926_3_; ++i) {
                ...
                for (int k = -j; k <= j && flag; ++k) {
                    for (int l = -j; l <= j && flag; ++l) {
                        if (0 > p_175926_2_.getY() + i || 256 <= p_175926_2_.getY() + i || !this.func_150523_a(worldIn.getBlockState(p_175926_2_.add(k, i, l)).getBlock())) {
                            flag = false;
                        }
                    }
                }
    ...
    private boolean func_175927_a(BlockPos p_175927_1_, World worldIn) {
        ...
        if ((block == Blocks.grass || block == Blocks.dirt) && 2 <= p_175927_1_.getY()) {
