        ...
        if (1 <= position.getY() && 256 >= position.getY() + i + 1) {
            ...
            if (!flag) {
                ...
                if ((block == Blocks.grass || block == Blocks.dirt) && position.getY() < 256 - i - 1) {
                    ...
                    for (int j3 = -3; 3 >= j3; ++j3) {
                        for (int i4 = -3; 3 >= i4; ++i4) {
                            if (3 != Math.abs(j3) || 3 != Math.abs(i4)) {
                    ...
                    for (int k3 = -1; 1 >= k3; ++k3) {
                        for (int j4 = -1; 1 >= j4; ++j4) {
                    ...
                    if (enumfacing1 != enumfacing) {
                        ...
                        if (0 < k1) {
                            ...
                            for (int i5 = -2; 2 >= i5; ++i5) {
                                for (int k5 = -2; 2 >= k5; ++k5) {
                                    if (2 != Math.abs(i5) || 2 != Math.abs(k5)) {
