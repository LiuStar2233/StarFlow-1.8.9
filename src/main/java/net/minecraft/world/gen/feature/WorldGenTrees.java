...
public class WorldGenTrees extends WorldGenAbstractTree {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (1 <= position.getY() && 256 >= position.getY() + i + 1) {
                ...
                if ((block1 == Blocks.grass || block1 == Blocks.dirt || block1 == Blocks.farmland) && position.getY() < 256 - i - 1) {
                    ...
                    for (int i3 = position.getY() - k2 + i; i3 <= position.getY() + i; ++i3) {
                        ...
                        for (int k1 = position.getX() - j1; k1 <= position.getX() + j1; ++k1) {
                            ...
                            for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || 0 != rand.nextInt(2) && 0 != i4) {
                    ...
                    for (int j3 = 0; j3 < i; ++j3) {
                        ...
                        if (block2.getMaterial() == Material.air || block2.getMaterial() == Material.leaves || block2.getMaterial() == Material.vine) {
                            ...
                            if (this.vinesGrow && 0 < j3) {
                                if (0 < rand.nextInt(3) && worldIn.isAirBlock(position.add(-1, j3, 0))) {
                                ...
                                if (0 < rand.nextInt(3) && worldIn.isAirBlock(position.add(0, j3, -1))) {
                    ...
                    if (this.vinesGrow) {
                            ...
                            for (int l4 = position.getX() - k4; l4 <= position.getX() + k4; ++l4) {
                                for (int i5 = position.getZ() - k4; i5 <= position.getZ() + k4; ++i5) {
                                    ...
                                    if (worldIn.getBlockState(blockpos$mutableblockpos1).getBlock().getMaterial() == Material.leaves) {
                                        ...
                                        if (0 == rand.nextInt(4) && worldIn.getBlockState(blockpos2).getBlock().getMaterial() == Material.air) {
                                            this.func_181650_b(worldIn, blockpos2, BlockVine.EAST);
                                        }

                                        if (0 == rand.nextInt(4) && worldIn.getBlockState(blockpos3).getBlock().getMaterial() == Material.air) {
                                            this.func_181650_b(worldIn, blockpos3, BlockVine.WEST);
                                        }

                                        if (0 == rand.nextInt(4) && worldIn.getBlockState(blockpos4).getBlock().getMaterial() == Material.air) {
                                            this.func_181650_b(worldIn, blockpos4, BlockVine.SOUTH);
                                        }

                                        if (0 == rand.nextInt(4) && worldIn.getBlockState(blockpos1).getBlock().getMaterial() == Material.air) {
                        ...
                        if (0 == rand.nextInt(5) && 5 < i) {
                            for (int l3 = 0; 2 > l3; ++l3) {
                                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                                    if (0 == rand.nextInt(4 - l3)) {
    ...
    private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
        ...
        for (p_181650_2_ = p_181650_2_.down(); p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air && 0 < i; --i) {
            this.func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
