...
public class GenLayerBiomeEdge extends GenLayer {
    ...
    private boolean canBiomesBeNeighbors(int p_151634_1_, int p_151634_2_) {
        if (biomesEqualOrMesaPlateau(p_151634_1_, p_151634_2_)) {
            ...
            if (null != biomegenbase && null != biomegenbase1) {
                ...
                return biomegenbase$tempcategory == biomegenbase$tempcategory1 || BiomeGenBase.TempCategory.MEDIUM == biomegenbase$tempcategory || BiomeGenBase.TempCategory.MEDIUM == biomegenbase$tempcategory1;
            } else {
                return false;
            }
        }
