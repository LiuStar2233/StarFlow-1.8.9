    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                boolean flag = 0 == (l - 2) % 29;

                if (255 < k) {
                    logger.debug("old! " + k);
                }

                if (0 != k && 2 <= l && 1 == (l - 2) % 29 && 128 > k) {
                    if (null != BiomeGenBase.getBiome(k + 128)) {
                        aint2[j + i * areaWidth] = k + 128;
                    } else {
                        aint2[j + i * areaWidth] = k;
                    }
                } else if (0 != nextInt(3) && !flag) {
                    aint2[j + i * areaWidth] = k;
                } else {
                    int i1 = k;
                    ...
                    } else if (k == BiomeGenBase.deepOcean.biomeID && 0 == nextInt(3)) {
                    ...
                    if (flag && i1 != k) {
                        if (null != BiomeGenBase.getBiome(i1 + 128)) {
                            i1 += 128;
                        } else {
                            i1 = k;
                        }
