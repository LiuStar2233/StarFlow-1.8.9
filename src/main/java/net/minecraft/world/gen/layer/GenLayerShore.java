...
public class GenLayerShore extends GenLayer {
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                if (k == BiomeGenBase.mushroomIsland.biomeID) {
                ...
                } else if (null != biomegenbase && BiomeGenJungle.class == biomegenbase.getBiomeClass()) {
                    ...
                    if (null != biomegenbase && biomegenbase.isSnowyBiome()) {
    ...
    private boolean func_151631_c(int p_151631_1_) {
        return null != BiomeGenBase.getBiome(p_151631_1_) && BiomeGenJungle.class == BiomeGenBase.getBiome(p_151631_1_).getBiomeClass() || p_151631_1_ == BiomeGenBase.jungleEdge.biomeID || p_151631_1_ == BiomeGenBase.jungle.biomeID || p_151631_1_ == BiomeGenBase.jungleHills.biomeID || p_151631_1_ == BiomeGenBase.forest.biomeID || p_151631_1_ == BiomeGenBase.taiga.biomeID || isBiomeOceanic(p_151631_1_);
    }
