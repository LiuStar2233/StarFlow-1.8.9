...
public class MapGenStronghold extends MapGenStructure {
    ...
    public MapGenStronghold() {
        ...
        for (BiomeGenBase biomegenbase : BiomeGenBase.getBiomeGenArray()) {
            if (null != biomegenbase && 0.0F < biomegenbase.minHeight) {
    ...
    public MapGenStronghold(Map<String, String> p_i2068_1_) {
        ...
        for (Map.Entry<String, String> entry : p_i2068_1_.entrySet()) {
            ...
            } else if ("spread".equals(entry.getKey())) {
    ...
    protected StructureStart getStructureStart(int chunkX, int chunkZ) {
        ...
        for (mapgenstronghold$start = new MapGenStronghold.Start(this.worldObj, this.rand, chunkX, chunkZ); mapgenstronghold$start.getComponents().isEmpty() || null == ((StructureStrongholdPieces.Stairs2) mapgenstronghold$start.getComponents().get(0)).strongholdPortalRoom; mapgenstronghold$start = new MapGenStronghold.Start(this.worldObj, this.rand, chunkX, chunkZ)) {
        }
