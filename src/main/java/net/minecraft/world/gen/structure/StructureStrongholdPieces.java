...
public class StructureStrongholdPieces {
    private static final StructureStrongholdPieces.PieceWeight[] pieceWeightArray = {new PieceWeight(Straight.class, 40, 0), new PieceWeight(Prison.class, 5, 5), new PieceWeight(LeftTurn.class, 20, 0), new PieceWeight(RightTurn.class, 20, 0), new PieceWeight(RoomCrossing.class, 10, 6), new PieceWeight(StairsStraight.class, 5, 5), new PieceWeight(Stairs.class, 5, 5), new PieceWeight(Crossing.class, 5, 4), new PieceWeight(ChestCorridor.class, 5, 4), new PieceWeight(Library.class, 10, 2) {
        public boolean canSpawnMoreStructuresOfType(int p_75189_1_) {
            return super.canSpawnMoreStructuresOfType(p_75189_1_) && 4 < p_75189_1_;
        }
    }, new PieceWeight(PortalRoom.class, 20, 1) {
        public boolean canSpawnMoreStructuresOfType(int p_75189_1_) {
            return super.canSpawnMoreStructuresOfType(p_75189_1_) && 5 < p_75189_1_;
        }
    }
    };
    ...
    private static boolean canAddStructurePieces() {
        ...
        for (StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
            if (0 < structurestrongholdpieces$pieceweight.instancesLimit && structurestrongholdpieces$pieceweight.instancesSpawned < structurestrongholdpieces$pieceweight.instancesLimit) {
                flag = true;
            }
    ...
    private static StructureStrongholdPieces.Stronghold func_175954_a(Class<? extends StructureStrongholdPieces.Stronghold> p_175954_0_, List<StructureComponent> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, EnumFacing p_175954_6_, int p_175954_7_) {
        ...
        } else if (Prison.class == p_175954_0_) {
        ...
        } else if (LeftTurn.class == p_175954_0_) {
        ...
        } else if (RightTurn.class == p_175954_0_) {
        ...
        } else if (RoomCrossing.class == p_175954_0_) {
        ...
        } else if (StairsStraight.class == p_175954_0_) {
        ...
        } else if (Stairs.class == p_175954_0_) {
        ...
        } else if (Crossing.class == p_175954_0_) {
        ...
        } else if (ChestCorridor.class == p_175954_0_) {
        ...
        } else if (Library.class == p_175954_0_) {
        ...
        } else if (PortalRoom.class == p_175954_0_) {
    ...
    private static StructureStrongholdPieces.Stronghold func_175955_b(StructureStrongholdPieces.Stairs2 p_175955_0_, List<StructureComponent> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_) {
        if (!canAddStructurePieces()) {
            ...
            if (null != StructureStrongholdPieces.strongComponentType) {
                ...
                if (null != structurestrongholdpieces$stronghold) {
                    return structurestrongholdpieces$stronghold;
                }
            }
            ...
            while (5 > j) {
                ...
                for (StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
                    ...
                    if (0 > i) {
                        ...
                        if (null != structurestrongholdpieces$stronghold1) {
            ...
            if (null != structureboundingbox && 1 < structureboundingbox.minY) {
    ...
    private static StructureComponent func_175953_c(StructureStrongholdPieces.Stairs2 p_175953_0_, List<StructureComponent> p_175953_1_, Random p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, EnumFacing p_175953_6_, int p_175953_7_) {
        if (50 < p_175953_7_) {
            return null;
        } else if (112 >= Math.abs(p_175953_3_ - p_175953_0_.getBoundingBox().minX) && 112 >= Math.abs(p_175953_5_ - p_175953_0_.getBoundingBox().minZ)) {
    ...
    public static class ChestCorridor extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.ChestCorridor func_175868_a(List<StructureComponent> p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, EnumFacing p_175868_5_, int p_175868_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175868_0_, structureboundingbox) ? new StructureStrongholdPieces.ChestCorridor(p_175868_6_, p_175868_1_, structureboundingbox, p_175868_5_) : null;
        }
    ...
    public static class Corridor extends StructureStrongholdPieces.Stronghold {
        ...
        public Corridor(int p_i45581_1_, Random p_i45581_2_, StructureBoundingBox p_i45581_3_, EnumFacing p_i45581_4_) {
            ...
            this.field_74993_a = EnumFacing.NORTH != p_i45581_4_ && EnumFacing.SOUTH != p_i45581_4_ ? p_i45581_3_.getXSize() : p_i45581_3_.getZSize();
        }
    ...
    public static class Crossing extends StructureStrongholdPieces.Stronghold {
        ...
        public Crossing(int p_i45580_1_, Random p_i45580_2_, StructureBoundingBox p_i45580_3_, EnumFacing p_i45580_4_) {
            ...
            this.field_74999_h = 0 < p_i45580_2_.nextInt(3);
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            if (EnumFacing.WEST == coordBaseMode || EnumFacing.NORTH == coordBaseMode) {
                i = 8 - i;
                j = 8 - j;
            }
        ...
        public static StructureStrongholdPieces.Crossing func_175866_a(List<StructureComponent> p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, EnumFacing p_175866_5_, int p_175866_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175866_0_, structureboundingbox) ? new StructureStrongholdPieces.Crossing(p_175866_6_, p_175866_1_, structureboundingbox, p_175866_5_) : null;
        }
    ...
    public static class LeftTurn extends StructureStrongholdPieces.Stronghold {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            if (EnumFacing.NORTH != coordBaseMode && EnumFacing.EAST != coordBaseMode) {
        ...
        public static StructureStrongholdPieces.LeftTurn func_175867_a(List<StructureComponent> p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, EnumFacing p_175867_5_, int p_175867_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175867_0_, structureboundingbox) ? new StructureStrongholdPieces.LeftTurn(p_175867_6_, p_175867_1_, structureboundingbox, p_175867_5_) : null;
        }
    ...
    public static class Library extends StructureStrongholdPieces.Stronghold {
        ...
        public Library(int p_i45578_1_, Random p_i45578_2_, StructureBoundingBox p_i45578_3_, EnumFacing p_i45578_4_) {
            ...
            this.isLargeRoom = 6 < p_i45578_3_.getYSize();
        }
        ...
        public static StructureStrongholdPieces.Library func_175864_a(List<StructureComponent> p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, EnumFacing p_175864_5_, int p_175864_6_) {
            ...
            if (!canStrongholdGoDeeper(structureboundingbox) || null != findIntersecting(p_175864_0_, structureboundingbox)) {
    ...
    static class PieceWeight {
        ...
        public boolean canSpawnMoreStructuresOfType(int p_75189_1_) {
            return 0 == instancesLimit || this.instancesSpawned < this.instancesLimit;
        }
    ...
    public static class PortalRoom extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.PortalRoom func_175865_a(List<StructureComponent> p_175865_0_, Random p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, EnumFacing p_175865_5_, int p_175865_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175865_0_, structureboundingbox) ? new StructureStrongholdPieces.PortalRoom(p_175865_6_, p_175865_1_, structureboundingbox, p_175865_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 4, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 5, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 6, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 4, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 5, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 6, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 3, 3, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 3, 3, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 3, 3, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 7, 3, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 7, 3, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty(BlockEndPortalFrame.EYE, Boolean.valueOf(0.9F < randomIn.nextFloat())), 7, 3, 11, structureBoundingBoxIn);
    ...
    public static class Prison extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.Prison func_175860_a(List<StructureComponent> p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, EnumFacing p_175860_5_, int p_175860_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175860_0_, structureboundingbox) ? new StructureStrongholdPieces.Prison(p_175860_6_, p_175860_1_, structureboundingbox, p_175860_5_) : null;
        }
    ...
    public static class RoomCrossing extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.RoomCrossing func_175859_a(List<StructureComponent> p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, EnumFacing p_175859_5_, int p_175859_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175859_0_, structureboundingbox) ? new StructureStrongholdPieces.RoomCrossing(p_175859_6_, p_175859_1_, structureboundingbox, p_175859_5_) : null;
        }
    ...
    public static class Stairs extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.Stairs func_175863_a(List<StructureComponent> p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, EnumFacing p_175863_5_, int p_175863_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175863_0_, structureboundingbox) ? new StructureStrongholdPieces.Stairs(p_175863_6_, p_175863_1_, structureboundingbox, p_175863_5_) : null;
        }
    ...
    public static class Stairs2 extends StructureStrongholdPieces.Stairs {
        ...
        public BlockPos getBoundingBoxCenter() {
            return null != strongholdPortalRoom ? this.strongholdPortalRoom.getBoundingBoxCenter() : super.getBoundingBoxCenter();
        }
    }
    ...
    public static class StairsStraight extends StructureStrongholdPieces.Stronghold {
        ...
        public static StructureStrongholdPieces.StairsStraight func_175861_a(List<StructureComponent> p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, EnumFacing p_175861_5_, int p_175861_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175861_0_, structureboundingbox) ? new StructureStrongholdPieces.StairsStraight(p_175861_6_, p_175861_1_, structureboundingbox, p_175861_5_) : null;
        }
    ...
    public static class Straight extends StructureStrongholdPieces.Stronghold {
        ...
        public Straight(int p_i45573_1_, Random p_i45573_2_, StructureBoundingBox p_i45573_3_, EnumFacing p_i45573_4_) {
            ...
            this.expandsX = 0 == p_i45573_2_.nextInt(2);
            this.expandsZ = 0 == p_i45573_2_.nextInt(2);
        }
        ...
        public static StructureStrongholdPieces.Straight func_175862_a(List<StructureComponent> p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, EnumFacing p_175862_5_, int p_175862_6_) {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && null == findIntersecting(p_175862_0_, structureboundingbox) ? new StructureStrongholdPieces.Straight(p_175862_6_, p_175862_1_, structureboundingbox, p_175862_5_) : null;
        }
    ...
    abstract static class Stronghold extends StructureComponent {
        ...
        protected static boolean canStrongholdGoDeeper(StructureBoundingBox p_74991_0_) {
            return null != p_74991_0_ && 10 < p_74991_0_.minY;
        }
